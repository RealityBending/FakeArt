...
cols_index <- c("Baseline" = "#E91E63", "Forgery" = "#F5A41D", "AI" = "#1D9AF5")
fmt_r <- function(x) sub("^(-?)0\\.", "\\1.", sprintf("%.2f", x)) # .45, -.07

# Models with participant-level indices, in the order of 3_models.qmd
...
individual <- read_estimates(models, dir = "individual")
...
df_long <- bind_rows(lapply(individual, function(e) mutate(e$individual, Model = e$outcome))) |>
  mutate(Model = factor(Model, levels = models),
         Parameter = factor(Parameter, levels = unique(unlist(lapply(outcome_info[models], `[[`, "individual")))),
         Index = factor(Index, levels = c("Baseline", "Forgery", "AI"))) |>
...
```{=html}
<div id="vkjocbehxl" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>#vkjocbehxl table {
  font-family: system-ui, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji';
  -webkit-font-smoothing: antialiased;
  -moz-osx-font-smoothing: grayscale;
}

#vkjocbehxl thead, #vkjocbehxl tbody, #vkjocbehxl tfoot, #vkjocbehxl tr, #vkjocbehxl td, #vkjocbehxl th {
  border-style: none;
}
...
#vkjocbehxl .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D5D5D5;
}

#vkjocbehxl .gt_col_headings {
  border-top-style: solid;
...
#vkjocbehxl .gt_column_spanner_outer {
  color: #FFFFFF;
  background-color: #000000;
  font-size: 100%;
  font-weight: normal;
...
#vkjocbehxl .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#vkjocbehxl .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#vkjocbehxl .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D5D5D5;
  vertical-align: bottom;
...
#vkjocbehxl .gt_spanner_row {
  border-bottom-style: hidden;
}

#vkjocbehxl .gt_group_heading {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#vkjocbehxl .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#vkjocbehxl .gt_from_md > :first-child {
  margin-top: 0;
}

#vkjocbehxl .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#vkjocbehxl .gt_row_group_first td {
  border-top-width: 2px;
}

#vkjocbehxl .gt_row_group_first th {
  border-top-width: 2px;
}

#vkjocbehxl .gt_summary_row {
  color: #333333;
...
#vkjocbehxl .gt_first_summary_row {
  border-top-style: solid;
  border-top-color: #D5D5D5;
}

#vkjocbehxl .gt_first_summary_row.thick {
  border-top-width: 2px;
}

#vkjocbehxl .gt_last_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#vkjocbehxl .gt_grand_summary_row {
  color: #FFFFFF;
...
#vkjocbehxl .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#vkjocbehxl .gt_last_grand_summary_row_top {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#vkjocbehxl .gt_striped {
  background-color: #F4F4F4;
}

#vkjocbehxl .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D5D5D5;
  border-bottom-style: solid;
...
#vkjocbehxl .gt_font_normal {
  font-weight: normal;
}

#vkjocbehxl .gt_font_bold {
  font-weight: bold;
}

#vkjocbehxl .gt_font_italic {
  font-style: italic;
}
...
#vkjocbehxl .gt_footnote_marks {
  font-size: 75%;
  vertical-align: 0.4em;
  position: initial;
}

#vkjocbehxl .gt_asterisk {
  font-size: 100%;
  vertical-align: 0;
}

#vkjocbehxl .gt_indent_1 {
  text-indent: 5px;
}

#vkjocbehxl .gt_indent_2 {
  text-indent: 10px;
}

#vkjocbehxl .gt_indent_3 {
  text-indent: 15px;
}

#vkjocbehxl .gt_indent_4 {
  text-indent: 20px;
}

#vkjocbehxl .gt_indent_5 {
  text-indent: 25px;
}

#vkjocbehxl .katex-display {
  display: inline-flex !important;
  margin-bottom: 0.75em !important;
}

#vkjocbehxl div.Reactable > div.rt-table > div.rt-thead > div.rt-tr.rt-tr-group-header > div.rt-th-group:after {
...
::: {.cell-output-display}
![Distribution of the participants' posterior means per index, on the link scale of each parameter.](5_correlates_files/figure-html/fig-individual-1.png){#fig-individual width=1536}
:::
:::
...
::: {.cell-output-display}
![Reliability (D-vour) of each participant-level index, with 95% bootstrap CI. Dashed lines at .5 and .75.](5_correlates_files/figure-html/fig-reliability-1.png){#fig-reliability width=864}
:::
:::
...
|Parameter1                      |Beauty_precleft_Baseline |Beauty_precleft_Forgery |Beauty_precright_AI |Beauty_precright_Baseline |Beauty_precright_Forgery |Worth_disc_Baseline |Valence_phi_Baseline |Meaning_phi_Baseline |Reality_precright_AI |Authenticity_precright_AI |Reality_confleft_Forgery |Reality_mu_AI |Authenticity_mu_Forgery |Beauty_confright_Baseline |Meaning_mu_Baseline |Worth_mu_Baseline |Beauty_mu_Baseline |Valence_mu_Baseline |Valence_phi_Forgery |Meaning_pzero_AI |Reality_confleft_AI |Authenticity_confleft_AI |Authenticity_confright_AI |Reality_confright_AI |Reality_confright_Baseline |Authenticity_confright_Baseline |Reality_confleft_Baseline |Authenticity_confleft_Baseline |Authenticity_precleft_Forgery |Reality_precright_Forgery |Authenticity_precright_Forgery |Reality_precleft_Forgery |Reality_precright_Baseline |Authenticity_precright_Baseline |Reality_precleft_Baseline |Authenticity_precleft_Baseline |Beauty_precleft_AI |Valence_phi_AI |Meaning_phi_Forgery |Beauty_mu_Forgery |Valence_mu_Forgery |Reality_confright_Forgery |Authenticity_confright_Forgery |Reality_precleft_AI |Authenticity_precleft_AI |Beauty_confright_Forgery |Beauty_confright_AI |Beauty_mu_AI |Valence_mu_AI |Worth_mu_Forgery |Worth_mu_AI |Meaning_mu_Forgery |Meaning_mu_AI |Reality_mu_Baseline |Reality_mu_Forgery |Authenticity_mu_Baseline |Authenticity_mu_AI |Meaning_pzero_Forgery |Beauty_confleft_AI |Meaning_pzero_Baseline |Beauty_confleft_Baseline |Beauty_confleft_Forgery |Meaning_phi_AI |
|:-------------------------------|:------------------------|:-----------------------|:-------------------|:-------------------------|:------------------------|:-------------------|:--------------------|:--------------------|:--------------------|:-------------------------|:------------------------|:-------------|:-----------------------|:-------------------------|:-------------------|:-----------------|:------------------|:-------------------|:-------------------|:----------------|:-------------------|:------------------------|:-------------------------|:--------------------|:--------------------------|:-------------------------------|:-------------------------|:------------------------------|:-----------------------------|:-------------------------|:------------------------------|:------------------------|:--------------------------|:-------------------------------|:-------------------------|:------------------------------|:------------------|:--------------|:-------------------|:-----------------|:------------------|:-------------------------|:------------------------------|:-------------------|:------------------------|:------------------------|:-------------------|:------------|:-------------|:----------------|:-----------|:------------------|:-------------|:-------------------|:------------------|:------------------------|:------------------|:---------------------|:------------------|:----------------------|:------------------------|:-----------------------|:--------------|
|Beauty_precleft_Forgery         |.81                      |NA                      |NA                  |NA                        |NA                       |NA                  |NA                   |NA                   |NA                   |NA                        |NA                       |NA            |NA                      |NA                        |NA                  |NA                |NA                 |NA                  |NA                  |NA               |NA                  |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                  |NA                       |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Beauty_precright_AI             |.18                      |.11                     |NA                  |NA                        |NA                       |NA                  |NA                   |NA                   |NA                   |NA                        |NA                       |NA            |NA                      |NA                        |NA                  |NA                |NA                 |NA                  |NA                  |NA               |NA                  |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                  |NA                       |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Beauty_precright_Baseline       |.41                      |.32                     |.59                 |NA                        |NA                       |NA                  |NA                   |NA                   |NA                   |NA                        |NA                       |NA            |NA                      |NA                        |NA                  |NA                |NA                 |NA                  |NA                  |NA               |NA                  |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                  |NA                       |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Beauty_precright_Forgery        |.36                      |.26                     |.50                 |.89                       |NA                       |NA                  |NA                   |NA                   |NA                   |NA                        |NA                       |NA            |NA                      |NA                        |NA                  |NA                |NA                 |NA                  |NA                  |NA               |NA                  |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                  |NA                       |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Worth_disc_Baseline             |.18                      |.10                     |.21                 |.38                       |.32                      |NA                  |NA                   |NA                   |NA                   |NA                        |NA                       |NA            |NA                      |NA                        |NA                  |NA                |NA                 |NA                  |NA                  |NA               |NA                  |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                  |NA                       |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Valence_phi_Baseline            |.32                      |.24                     |.30                 |.51                       |.45                      |.48                 |NA                   |NA                   |NA                   |NA                        |NA                       |NA            |NA                      |NA                        |NA                  |NA                |NA                 |NA                  |NA                  |NA               |NA                  |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                  |NA                       |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Meaning_phi_Baseline            |.22                      |.14                     |.25                 |.45                       |.39                      |.37                 |.55                  |NA                   |NA                   |NA                        |NA                       |NA            |NA                      |NA                        |NA                  |NA                |NA                 |NA                  |NA                  |NA               |NA                  |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                  |NA                       |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Reality_precright_AI            |.03                      |.10                     |-.05                |.00                       |.01                      |.07                 |.03                  |.04                  |NA                   |NA                        |NA                       |NA            |NA                      |NA                        |NA                  |NA                |NA                 |NA                  |NA                  |NA               |NA                  |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                  |NA                       |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Authenticity_precright_AI       |.15                      |.21                     |-.02                |.04                       |-.00                     |-.01                |.09                  |-.02                 |.17                  |NA                        |NA                       |NA            |NA                      |NA                        |NA                  |NA                |NA                 |NA                  |NA                  |NA               |NA                  |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                  |NA                       |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Reality_confleft_Forgery        |.03                      |.03                     |.01                 |-.00                      |.03                      |.06                 |.12                  |-.01                 |.02                  |.04                       |NA                       |NA            |NA                      |NA                        |NA                  |NA                |NA                 |NA                  |NA                  |NA               |NA                  |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                  |NA                       |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Reality_mu_AI                   |.05                      |.05                     |-.04                |.05                       |.06                      |.07                 |.09                  |.00                  |.02                  |.02                       |.07                      |NA            |NA                      |NA                        |NA                  |NA                |NA                 |NA                  |NA                  |NA               |NA                  |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                  |NA                       |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Authenticity_mu_Forgery         |.02                      |.01                     |-.01                |-.03                      |-.04                     |-.00                |.02                  |-.00                 |.01                  |.09                       |.07                      |.13           |NA                      |NA                        |NA                  |NA                |NA                 |NA                  |NA                  |NA               |NA                  |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                  |NA                       |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Beauty_confright_Baseline       |-.12                     |-.09                    |-.46                |-.61                      |-.59                     |-.39                |-.56                 |-.43                 |-.02                 |.04                       |-.02                     |-.13          |-.00                    |NA                        |NA                  |NA                |NA                 |NA                  |NA                  |NA               |NA                  |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                  |NA                       |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Meaning_mu_Baseline             |.07                      |.11                     |-.23                |-.29                      |-.29                     |-.19                |-.34                 |-.10                 |.01                  |.06                       |-.00                     |-.09          |-.05                    |.60                       |NA                  |NA                |NA                 |NA                  |NA                  |NA               |NA                  |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                  |NA                       |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Worth_mu_Baseline               |.18                      |.16                     |-.17                |-.15                      |-.19                     |-.16                |-.26                 |-.13                 |-.05                 |.10                       |-.01                     |-.08          |.00                     |.41                       |.51                 |NA                |NA                 |NA                  |NA                  |NA               |NA                  |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                  |NA                       |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Beauty_mu_Baseline              |.15                      |.15                     |-.14                |-.15                      |-.15                     |-.09                |-.01                 |.09                  |.08                  |.10                       |-.06                     |-.10          |-.04                    |.45                       |.55                 |.47               |NA                 |NA                  |NA                  |NA               |NA                  |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                  |NA                       |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Valence_mu_Baseline             |.18                      |.15                     |-.13                |-.12                      |-.15                     |-.02                |-.02                 |.06                  |.02                  |.07                       |-.02                     |-.05          |-.05                    |.45                       |.56                 |.51               |.74                |NA                  |NA                  |NA               |NA                  |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                  |NA                       |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Valence_phi_Forgery             |.02                      |.07                     |-.01                |-.06                      |-.01                     |-.06                |-.04                 |-.04                 |-.05                 |-.05                      |.04                      |.07           |-.04                    |.03                       |.08                 |.11               |.00                |.11                 |NA                  |NA               |NA                  |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                  |NA                       |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Meaning_pzero_AI                |.02                      |.07                     |-.06                |-.01                      |.05                      |-.11                |.05                  |-.03                 |.04                  |-.02                      |-.04                     |-.02          |.06                     |.01                       |-.00                |.05               |.09                |.05                 |.15                 |NA               |NA                  |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                  |NA                       |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Reality_confleft_AI             |-.02                     |-.03                    |.00                 |.05                       |.05                      |.02                 |.05                  |.06                  |.03                  |-.05                      |-.55                     |-.04          |.01                     |-.01                      |.01                 |.04               |.13                |.08                 |-.02                |.03              |NA                  |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                  |NA                       |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Authenticity_confleft_AI        |-.07                     |-.04                    |-.01                |-.04                      |-.00                     |-.01                |-.11                 |-.08                 |-.06                 |.06                       |-.25                     |-.00          |.11                     |.16                       |.10                 |.06               |.06                |.11                 |-.02                |-.03             |.19                 |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                  |NA                       |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Authenticity_confright_AI       |.07                      |.02                     |-.07                |-.11                      |-.10                     |-.08                |-.18                 |-.18                 |-.10                 |.04                       |-.14                     |.03           |-.11                    |.24                       |.11                 |.07               |.01                |.07                 |-.05                |-.03             |.11                 |.28                      |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                  |NA                       |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Reality_confright_AI            |-.03                     |-.04                    |-.13                |-.20                      |-.20                     |-.11                |-.26                 |-.23                 |-.07                 |.04                       |-.15                     |-.05          |-.13                    |.32                       |.13                 |.12               |.06                |.12                 |-.08                |-.04             |.02                 |.39                      |.69                       |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                  |NA                       |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Reality_confright_Baseline      |-.07                     |-.07                    |-.12                |-.22                      |-.23                     |-.19                |-.33                 |-.28                 |-.13                 |.04                       |-.21                     |-.10          |-.10                    |.37                       |.16                 |.15               |.03                |.12                 |-.07                |-.06             |.04                 |.46                      |.63                       |.83                  |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                  |NA                       |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Authenticity_confright_Baseline |-.05                     |-.07                    |-.14                |-.21                      |-.21                     |-.19                |-.32                 |-.27                 |-.12                 |.05                       |-.20                     |-.07          |-.12                    |.35                       |.19                 |.15               |.02                |.11                 |-.08                |-.12             |.06                 |.46                      |.70                       |.77                  |.93                        |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                  |NA                       |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Reality_confleft_Baseline       |-.10                     |-.08                    |-.13                |-.21                      |-.21                     |-.13                |-.33                 |-.28                 |-.18                 |-.01                      |-.21                     |-.07          |-.03                    |.30                       |.11                 |.12               |-.05               |.05                 |-.04                |-.06             |.03                 |.49                      |.57                       |.70                  |.84                        |.82                             |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                  |NA                       |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Authenticity_confleft_Baseline  |-.08                     |-.10                    |-.11                |-.17                      |-.15                     |-.16                |-.30                 |-.25                 |-.14                 |.05                       |-.18                     |-.04          |.04                     |.28                       |.13                 |.13               |.00                |.07                 |-.06                |-.03             |.05                 |.56                      |.57                       |.70                  |.84                        |.85                             |.88                       |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                  |NA                       |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Authenticity_precleft_Forgery   |.11                      |.10                     |.01                 |.07                       |.06                      |.06                 |.11                  |.03                  |-.01                 |.03                       |.02                      |.07           |-.03                    |-.06                      |.03                 |-.05              |.10                |.03                 |.08                 |.01              |-.05                |-.01                     |-.02                      |-.02                 |-.02                       |-.03                            |-.01                      |.00                            |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                  |NA                       |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Reality_precright_Forgery       |.04                      |.01                     |.02                 |-.04                      |-.01                     |-.10                |.01                  |-.01                 |-.54                 |.01                       |-.06                     |.05           |.05                     |.06                       |.12                 |.10               |.06                |.11                 |.05                 |.02              |-.01                |.09                      |.10                       |.07                  |.09                        |.14                             |.12                       |.14                            |.14                           |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                  |NA                       |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Authenticity_precright_Forgery  |.13                      |.09                     |.09                 |.13                       |.12                      |.05                 |.10                  |.09                  |-.03                 |-.04                      |.09                      |.07           |-.00                    |-.05                      |-.04                |-.07              |.05                |.08                 |.01                 |-.10             |-.01                |.11                      |-.01                      |.02                  |-.00                       |.03                             |.04                       |.08                            |.17                           |.21                       |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                  |NA                       |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Reality_precleft_Forgery        |.17                      |.13                     |-.02                |.12                       |.12                      |.08                 |.14                  |.04                  |-.12                 |.10                       |-.03                     |.00           |-.05                    |-.02                      |.02                 |.05               |.04                |.05                 |-.05                |-.01             |.02                 |.08                      |.11                       |.07                  |.09                        |.09                             |.07                       |.09                            |.23                           |.17                       |.22                            |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                  |NA                       |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Reality_precright_Baseline      |.17                      |.18                     |.05                 |.20                       |.16                      |.11                 |.17                  |.13                  |-.05                 |.31                       |.01                      |.00           |-.02                    |-.07                      |.04                 |.03               |.13                |.11                 |-.08                |-.01             |-.00                |.13                      |.12                       |.11                  |.11                        |.12                             |.09                       |.17                            |.21                           |.28                       |.40                            |.41                      |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                  |NA                       |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Authenticity_precright_Baseline |.16                      |.17                     |.02                 |.16                       |.13                      |.11                 |.20                  |.16                  |-.00                 |.34                       |.09                      |.06           |-.02                    |-.08                      |-.01                |-.01              |.12                |.09                 |-.06                |-.05             |-.02                |.13                      |.05                       |.08                  |.04                        |.07                             |.04                       |.13                            |.23                           |.20                       |.58                            |.39                      |.83                        |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                  |NA                       |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Reality_precleft_Baseline       |.21                      |.21                     |.03                 |.21                       |.18                      |.00                 |.11                  |.08                  |-.05                 |.30                       |.03                      |.02           |-.07                    |-.03                      |.02                 |.04               |.04                |.08                 |.02                 |-.02             |-.03                |.13                      |.16                       |.14                  |.19                        |.20                             |.12                       |.20                            |.17                           |.22                       |.33                            |.60                      |.69                        |.65                             |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                  |NA                       |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Authenticity_precleft_Baseline  |.23                      |.23                     |-.02                |.17                       |.15                      |.04                 |.17                  |.10                  |.03                  |.28                       |-.03                     |.06           |-.08                    |-.08                      |-.00                |.02               |.14                |.11                 |.02                 |-.05             |-.03                |.05                      |.06                       |.02                  |.01                        |.05                             |-.04                      |.03                            |.22                           |.23                       |.32                            |.41                      |.63                        |.67                             |.68                       |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                  |NA                       |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Beauty_precleft_AI              |-.09                     |-.21                    |.02                 |-.04                      |-.04                     |.10                 |-.02                 |-.01                 |.01                  |-.05                      |-.01                     |.01           |-.00                    |.08                       |-.02                |-.10              |-.04               |-.02                |-.03                |-.12             |.04                 |-.03                     |.00                       |-.01                 |.02                        |.03                             |.03                       |.03                            |.07                           |-.03                      |.13                            |.12                      |.03                        |.06                             |.09                       |.01                            |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                  |NA                       |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Valence_phi_AI                  |.07                      |.04                     |.11                 |-.06                      |-.07                     |-.04                |.06                  |.01                  |-.03                 |.05                       |.09                      |-.02          |-.01                    |.07                       |.06                 |-.02              |.02                |.00                 |.02                 |-.13             |-.01                |.05                      |-.00                      |.04                  |.02                        |.02                             |.03                       |.03                            |.05                           |.10                       |.07                            |.02                      |.05                        |.05                             |.09                       |.00                            |.15                |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                  |NA                       |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Meaning_phi_Forgery             |.12                      |.11                     |.12                 |.04                       |.10                      |-.01                |.10                  |.10                  |-.05                 |.01                       |-.02                     |-.12          |-.07                    |-.03                      |-.09                |-.00              |-.00               |.02                 |.05                 |-.00             |.05                 |-.05                     |.02                       |-.03                 |-.01                       |-.01                            |-.03                      |-.06                           |-.00                          |.04                       |.06                            |.11                      |.10                        |.10                             |.10                       |-.00                           |.11                |.17            |NA                  |NA                |NA                 |NA                        |NA                             |NA                  |NA                       |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Beauty_mu_Forgery               |-.00                     |-.03                    |.07                 |.04                       |.05                      |.06                 |.11                  |-.04                 |-.06                 |.03                       |-.04                     |.00           |.02                     |-.09                      |-.12                |-.16              |-.27               |-.20                |.01                 |-.04             |.03                 |.00                      |.03                       |-.02                 |-.02                       |-.03                            |-.03                      |-.02                           |-.05                          |.05                       |.08                            |.03                      |.02                        |.02                             |.03                       |.05                            |-.03               |.02            |.08                 |NA                |NA                 |NA                        |NA                             |NA                  |NA                       |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Valence_mu_Forgery              |.03                      |.04                     |-.01                |.08                       |.06                      |.02                 |.17                  |.13                  |-.00                 |.01                       |-.01                     |-.06          |.08                     |-.16                      |-.21                |-.23              |-.15               |-.27                |-.01                |-.03             |.05                 |-.05                     |-.02                      |-.00                 |-.06                       |-.08                            |-.09                      |-.07                           |-.02                          |-.06                      |.09                            |.10                      |.11                        |.08                             |.13                       |.09                            |.05                |.13            |.12                 |.51               |NA                 |NA                        |NA                             |NA                  |NA                       |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Reality_confright_Forgery       |.02                      |.04                     |.02                 |.10                       |.12                      |.08                 |.20                  |.14                  |-.04                 |-.04                      |.08                      |.03           |.19                     |-.19                      |-.07                |-.09              |.01                |-.04                |-.01                |-.04             |-.03                |-.18                     |-.44                      |-.54                 |-.46                       |-.42                            |-.36                      |-.34                           |.04                           |.05                       |.01                            |-.04                     |.03                        |.05                             |-.01                      |.04                            |.02                |.03            |.08                 |.10               |.15                |NA                        |NA                             |NA                  |NA                       |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Authenticity_confright_Forgery  |-.06                     |-.06                    |-.04                |-.07                      |-.07                     |-.05                |-.06                 |-.06                 |-.04                 |-.03                      |.02                      |-.05          |.10                     |.06                       |-.02                |.04               |.02                |.02                 |-.06                |-.08             |.01                 |.09                      |-.33                      |-.05                 |.11                        |.13                             |.10                       |.15                            |-.06                          |-.02                      |.13                            |.02                      |-.02                       |.07                             |.01                       |-.01                           |.09                |.05            |.05                 |.10               |.12                |.26                       |NA                             |NA                  |NA                       |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Reality_precleft_AI             |-.10                     |-.05                    |.06                 |-.05                      |-.05                     |-.06                |-.09                 |-.05                 |.07                  |-.02                      |.08                      |.03           |-.00                    |.01                       |-.03                |.01               |.00                |-.02                |.02                 |-.04             |-.08                |-.06                     |-.01                      |.01                  |.00                        |-.01                            |-.01                      |.00                            |-.18                          |-.07                      |-.08                           |-.51                     |-.16                       |-.11                            |-.19                      |-.09                           |-.04               |.07            |-.08                |.01               |.03                |.01                       |-.02                           |NA                  |NA                       |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Authenticity_precleft_AI        |-.04                     |-.04                    |.10                 |.04                       |.05                      |.03                 |-.02                 |-.01                 |.11                  |-.09                      |.06                      |.08           |.05                     |.01                       |-.01                |-.02              |-.06               |-.05                |-.04                |-.03             |-.08                |.10                      |.00                       |.06                  |.04                        |.00                             |.07                       |.05                            |-.25                          |-.13                      |-.02                           |-.10                     |-.09                       |-.16                            |-.07                      |-.23                           |-.07               |.07            |.04                 |-.01              |.05                |-.07                      |.01                            |.23                 |NA                       |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Beauty_confright_Forgery        |-.06                     |-.03                    |-.32                |-.28                      |-.31                     |-.15                |-.32                 |-.18                 |.02                  |.09                       |.02                      |-.11          |.01                     |.49                       |.26                 |.19               |.22                |.20                 |-.12                |-.04             |-.03                |.05                      |.12                       |.20                  |.22                        |.22                             |.13                       |.13                            |-.08                          |-.04                      |-.02                           |-.04                     |-.01                       |-.03                            |-.01                      |.06                            |.03                |-.04           |-.11                |-.05              |.22                |-.01                      |.13                            |.04                 |.02                      |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Beauty_confright_AI             |.07                      |.06                     |-.10                |.16                       |.14                      |.15                 |.00                  |.13                  |.05                  |.08                       |-.04                     |.01           |.00                     |-.11                      |-.08                |-.04              |-.07               |-.07                |-.06                |-.16             |.01                 |.01                      |-.01                      |.04                  |-.01                       |.00                             |-.03                      |-.03                           |-.03                          |-.17                      |-.03                           |-.01                     |.06                        |.03                             |.02                       |.08                            |.02                |-.24           |-.08                |-.03              |.20                |.00                       |.01                            |.04                 |-.00                     |.45                      |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Beauty_mu_AI                    |-.01                     |-.04                    |.02                 |.03                       |-.01                     |.09                 |-.00                 |.00                  |-.01                 |-.02                      |.10                      |.13           |.04                     |.03                       |.05                 |-.00              |-.01               |.04                 |-.10                |-.31             |.00                 |.03                      |.10                       |.10                  |.07                        |.09                             |.05                       |.02                            |-.02                          |-.09                      |.03                            |-.03                     |-.04                       |.00                             |-.01                      |-.04                           |.03                |.09            |-.00                |.04               |.01                |.01                       |-.05                           |.05                 |.00                      |.04                      |.05                 |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Valence_mu_AI                   |-.02                     |-.03                    |-.04                |.06                       |.05                      |.11                 |.15                  |.09                  |-.00                 |-.05                      |.07                      |.06           |.02                     |-.12                      |-.09                |-.21              |-.07               |-.15                |-.08                |-.37             |.04                 |.06                      |.04                       |.06                  |.01                        |.02                             |.01                       |.00                            |.04                           |-.11                      |.04                            |-.02                     |.03                        |.01                             |.02                       |.01                            |.07                |.21            |.03                 |.17               |.44                |.09                       |.03                            |.04                 |.08                      |.10                      |.29                 |.53          |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Worth_mu_Forgery                |-.08                     |-.04                    |-.02                |.03                       |.03                      |.20                 |.05                  |.09                  |.00                  |-.03                      |.07                      |.02           |.03                     |-.11                      |-.20                |-.32              |-.13               |-.11                |-.12                |-.18             |-.02                |.01                      |-.02                      |-.02                 |-.05                       |-.04                            |-.05                      |-.06                           |.01                           |-.04                      |.15                            |.05                      |.03                        |.05                             |.05                       |.07                            |.05                |.06            |.06                 |.37               |.52                |.20                       |.17                            |.05                 |.04                      |.31                      |.28                 |.16          |.33           |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Worth_mu_AI                     |-.05                     |-.04                    |.01                 |.09                       |.07                      |.26                 |.03                  |.07                  |-.03                 |-.06                      |.05                      |.11           |.00                     |-.16                      |-.16                |-.34              |-.19               |-.11                |-.10                |-.42             |-.04                |.07                      |.04                       |.05                  |.00                        |.04                             |.06                       |-.00                           |.01                           |-.08                      |.10                            |.01                      |.02                        |.02                             |-.00                      |-.01                           |.07                |.03            |.02                 |.14               |.26                |.10                       |.08                            |.04                 |.08                      |.17                      |.41                 |.38          |.57           |.72              |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Meaning_mu_Forgery              |.03                      |.00                     |-.09                |-.03                      |-.03                     |-.02                |.02                  |.09                  |-.03                 |.04                       |-.01                     |.03           |-.01                    |-.00                      |-.14                |-.12              |-.05               |-.09                |-.14                |-.17             |.01                 |.04                      |.06                       |.05                  |.03                        |.04                             |-.02                      |.00                            |-.03                          |.02                       |.12                            |.16                      |.12                        |.13                             |.15                       |.15                            |-.03               |.07            |.28                 |.28               |.47                |.04                       |.12                            |.01                 |.10                      |.27                      |.11                 |.15          |.29           |.50              |.33         |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Meaning_mu_AI                   |.00                      |-.02                    |-.07                |.02                       |.03                      |.02                 |-.03                 |.04                  |-.03                 |.03                       |.02                      |.06           |-.02                    |-.06                      |-.07                |-.12              |-.06               |-.06                |-.11                |-.30             |.04                 |.10                      |.08                       |.10                  |.06                        |.08                             |.08                       |.06                            |-.08                          |-.10                      |.09                            |.05                      |.07                        |.06                             |.03                       |.02                            |-.08               |.01            |.06                 |.08               |.20                |.02                       |.05                            |.04                 |.10                      |.14                      |.25                 |.34          |.45           |.34              |.50         |.60                |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Reality_mu_Baseline             |.07                      |.07                     |.01                 |-.02                      |-.05                     |-.10                |-.05                 |-.01                 |-.00                 |.00                       |-.03                     |-.33          |-.11                    |.11                       |.11                 |.19               |.21                |.16                 |-.07                |.12              |.03                 |-.13                     |-.01                      |.09                  |.10                        |.03                             |-.13                      |-.07                           |-.00                          |-.03                      |.01                            |.07                      |-.00                       |-.03                            |.03                       |.05                            |-.07               |.03            |.06                 |-.04              |.03                |-.04                      |-.02                           |-.06                |-.05                     |.12                      |-.07                |.03          |-.04          |-.01             |-.16        |.04                |-.10          |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Reality_mu_Forgery              |.08                      |.06                     |.07                 |.03                       |.02                      |-.17                |-.01                 |.03                  |-.06                 |-.07                      |-.06                     |-.26          |.05                     |.03                       |.03                 |.10               |.14                |.10                 |-.09                |-.00             |.08                 |-.06                     |-.05                      |.05                  |.06                        |.03                             |-.09                      |-.01                           |-.05                          |-.01                      |.13                            |.13                      |.06                        |.08                             |.06                       |.10                            |.03                |.05            |.07                 |.03               |.11                |-.04                      |.07                            |-.04                |-.14                     |.04                      |-.08                |.03          |.01           |.04              |-.10        |.07                |-.05          |.59                 |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Authenticity_mu_Baseline        |.04                      |.02                     |-.03                |.00                       |-.00                     |-.01                |-.06                 |.05                  |.01                  |-.09                      |-.13                     |-.21          |-.73                    |.03                       |.06                 |-.02              |.04                |.06                 |-.02                |-.15             |-.00                |-.08                     |.14                       |.14                  |.10                        |.15                             |.02                       |-.07                           |.00                           |-.03                      |-.00                           |.06                      |.03                        |.03                             |.08                       |.11                            |-.01               |.01            |.03                 |.05               |.00                |-.09                      |-.09                           |.01                 |-.10                     |.06                      |.05                 |-.02         |.03           |.05              |.05         |.05                |.05           |.18                 |.09                |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Authenticity_mu_AI              |.00                      |.02                     |-.01                |-.01                      |.02                      |-.10                |-.00                 |.05                  |.04                  |-.05                      |-.01                     |.18           |-.24                    |.00                       |.01                 |.04               |.09                |.03                 |-.10                |-.06             |.04                 |-.10                     |.02                       |.06                  |-.00                       |.01                             |-.04                      |-.06                           |-.07                          |-.01                      |-.00                           |.02                      |.02                        |-.01                            |.02                       |.08                            |-.04               |.05            |.09                 |-.02              |.06                |-.02                      |-.05                           |.02                 |-.01                     |.08                      |-.01                |.01          |.09           |-.03             |-.04        |.14                |.07           |.08                 |.15                |.24                      |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Meaning_pzero_Forgery           |-.13                     |-.13                    |-.02                |.01                       |.04                      |.05                 |-.07                 |-.06                 |-.02                 |-.01                      |.02                      |.00           |.03                     |-.06                      |-.14                |-.09              |-.25               |-.17                |-.08                |-.27             |.01                 |-.03                     |-.07                      |-.02                 |.01                        |.01                             |.00                       |-.02                           |-.11                          |-.05                      |-.01                           |.03                      |-.01                       |-.02                            |-.02                      |-.02                           |.00                |-.10           |.01                 |-.13              |-.21               |-.05                      |-.00                           |-.08                |.00                      |-.05                     |.08                 |.04          |-.05          |-.11             |.09         |-.05               |.03           |-.03                |-.07               |-.00                     |-.10               |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Beauty_confleft_AI              |-.34                     |-.19                    |-.13                |-.18                      |-.11                     |-.13                |-.28                 |-.24                 |-.10                 |-.05                      |.00                      |-.09          |-.02                    |.16                       |-.08                |-.05              |-.22               |-.19                |-.01                |.21              |-.15                |.04                      |.06                       |.08                  |.14                        |.11                             |.22                       |.19                            |-.05                          |-.03                      |-.11                           |-.10                     |-.08                       |-.11                            |-.08                      |-.13                           |-.05               |-.25           |-.07                |.01               |-.09               |-.04                      |.05                            |.09                 |.01                      |.11                      |.03                 |-.09         |-.27          |-.04             |-.18        |-.06               |-.13          |-.10                |-.03               |-.03                     |-.03               |.07                   |NA                 |NA                     |NA                       |NA                      |NA             |
|Meaning_pzero_Baseline          |-.39                     |-.29                    |-.08                |-.16                      |-.13                     |-.17                |-.10                 |-.32                 |.02                  |-.07                      |-.08                     |.01           |.06                     |-.07                      |-.44                |-.38              |-.39               |-.41                |.02                 |.00              |.05                 |.06                      |.04                       |.03                  |.10                        |.09                             |.18                       |.14                            |-.06                          |-.04                      |-.07                           |-.08                     |-.20                       |-.15                            |-.17                      |-.14                           |.08                |.11            |-.03                |.08               |.09                |-.05                      |.07                            |.02                 |-.06                     |-.07                     |-.09                |-.07         |.03           |.06              |-.02        |-.01               |-.10          |-.11                |-.07               |-.11                     |-.07               |.15                   |.30                |NA                     |NA                       |NA                      |NA             |
|Beauty_confleft_Baseline        |-.56                     |-.45                    |-.23                |-.35                      |-.26                     |-.26                |-.49                 |-.41                 |-.11                 |-.08                      |-.05                     |-.07          |.00                     |.28                       |-.06                |-.16              |-.37               |-.36                |-.01                |.00              |-.05                |.12                      |.15                       |.17                  |.22                        |.19                             |.29                       |.25                            |-.04                          |-.04                      |-.08                           |-.07                     |-.13                       |-.15                            |-.10                      |-.17                           |.11                |-.05           |-.08                |.09               |.02                |-.13                      |.03                            |.00                 |.02                      |.17                      |.04                 |-.05         |-.03          |.05              |.02         |.01                |-.01          |-.11                |-.06               |-.02                     |-.07               |.12                   |.63                |.45                    |NA                       |NA                      |NA             |
|Beauty_confleft_Forgery         |-.41                     |-.37                    |-.16                |-.17                      |-.11                     |-.13                |-.20                 |-.25                 |-.03                 |-.03                      |-.00                     |-.04          |.07                     |.10                       |-.14                |-.23              |-.33               |-.29                |-.11                |-.02             |-.00                |.07                      |.11                       |.14                  |.16                        |.13                             |.17                       |.17                            |-.12                          |-.10                      |-.11                           |-.07                     |-.14                       |-.12                            |-.13                      |-.16                           |.04                |-.02           |-.12                |.17               |-.05               |-.12                      |.02                            |-.04                |.00                      |.08                      |.07                 |.01          |.05           |.04              |.07         |-.03               |-.03          |-.09                |-.05               |-.07                     |-.05               |.26                   |.38                |.41                    |.64                      |NA                      |NA             |
|Meaning_phi_AI                  |-.15                     |-.11                    |-.04                |-.27                      |-.19                     |-.22                |-.33                 |-.58                 |-.04                 |.03                       |.01                      |-.05          |.00                     |.21                       |.01                 |.09               |-.11               |-.05                |.03                 |-.04             |.00                 |.07                      |.18                       |.18                  |.20                        |.18                             |.21                       |.19                            |-.11                          |.06                       |-.01                           |-.03                     |-.03                       |-.03                            |-.02                      |-.04                           |-.01               |.17            |.15                 |.09               |-.06               |-.05                      |-.03                           |.08                 |.05                      |.06                      |-.11                |.08          |.01           |-.01             |.04         |.06                |.13           |.06                 |.08                |.02                      |.02                |.08                   |.09                |.16                    |.25                      |.19                     |NA             |
|Authenticity_confleft_Forgery   |-.06                     |-.09                    |-.15                |-.18                      |-.17                     |-.11                |-.16                 |-.19                 |-.02                 |.03                       |.15                      |-.03          |.08                     |.15                       |.03                 |.12               |-.06               |-.01                |-.04                |-.06             |-.09                |-.03                     |.29                       |.27                  |.34                        |.38                             |.41                       |.46                            |-.01                          |.00                       |-.06                           |-.00                     |.03                        |.01                             |.06                       |-.10                           |.05                |-.02           |-.02                |-.07              |-.08               |-.08                      |-.02                           |.01                 |.03                      |.11                      |.01                 |.03          |-.02          |-.09             |-.01        |-.09               |-.05          |-.06                |-.09               |-.13                     |.00                |.08                   |.12                |.11                    |.14                      |.11                     |.18            |
...
::: {.cell-output-display}
![Correlations between participant-level indices, clustered. Lower triangle: Pearson r (bold: p < .05, uncorrected). Diagonal: D-vour (orange = low, green = high).](5_correlates_files/figure-html/fig-correlation-1.png){#fig-correlation width=2112}
:::
:::
...
ega_features <- as.character(df_rel$Feature[df_rel$D_vour > 1/3])
...
```{=html}
<div id="slggonbbvn" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>#slggonbbvn table {
  font-family: system-ui, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji';
  -webkit-font-smoothing: antialiased;
  -moz-osx-font-smoothing: grayscale;
}

#slggonbbvn thead, #slggonbbvn tbody, #slggonbbvn tfoot, #slggonbbvn tr, #slggonbbvn td, #slggonbbvn th {
  border-style: none;
}
...
#slggonbbvn .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D5D5D5;
}

#slggonbbvn .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D5D5D5;
  border-bottom-style: solid;
...
#slggonbbvn .gt_column_spanner_outer {
  color: #FFFFFF;
  background-color: #000000;
  font-size: 100%;
  font-weight: normal;
...
#slggonbbvn .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#slggonbbvn .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#slggonbbvn .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D5D5D5;
  vertical-align: bottom;
...
#slggonbbvn .gt_spanner_row {
  border-bottom-style: hidden;
}

#slggonbbvn .gt_group_heading {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#slggonbbvn .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#slggonbbvn .gt_from_md > :first-child {
  margin-top: 0;
}

#slggonbbvn .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#slggonbbvn .gt_row_group_first td {
  border-top-width: 2px;
}

#slggonbbvn .gt_row_group_first th {
  border-top-width: 2px;
}

#slggonbbvn .gt_summary_row {
  color: #333333;
  background-color: #D5D5D5;
  text-transform: inherit;
  padding-top: 8px;
...
#slggonbbvn .gt_first_summary_row {
  border-top-style: solid;
  border-top-color: #D5D5D5;
}

#slggonbbvn .gt_first_summary_row.thick {
  border-top-width: 2px;
}

#slggonbbvn .gt_last_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#slggonbbvn .gt_grand_summary_row {
  color: #FFFFFF;
  background-color: #929292;
  text-transform: inherit;
  padding-top: 8px;
...
#slggonbbvn .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#slggonbbvn .gt_last_grand_summary_row_top {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#slggonbbvn .gt_striped {
  background-color: #F4F4F4;
}

#slggonbbvn .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D5D5D5;
  border-bottom-style: solid;
...
#slggonbbvn .gt_font_normal {
  font-weight: normal;
}

#slggonbbvn .gt_font_bold {
  font-weight: bold;
}

#slggonbbvn .gt_font_italic {
  font-style: italic;
}
...
#slggonbbvn .gt_footnote_marks {
  font-size: 75%;
  vertical-align: 0.4em;
  position: initial;
}

#slggonbbvn .gt_asterisk {
  font-size: 100%;
  vertical-align: 0;
}

#slggonbbvn .gt_indent_1 {
  text-indent: 5px;
}

#slggonbbvn .gt_indent_2 {
  text-indent: 10px;
}

#slggonbbvn .gt_indent_3 {
  text-indent: 15px;
}

#slggonbbvn .gt_indent_4 {
  text-indent: 20px;
}

#slggonbbvn .gt_indent_5 {
  text-indent: 25px;
}

#slggonbbvn .katex-display {
  display: inline-flex !important;
  margin-bottom: 0.75em !important;
}

#slggonbbvn div.Reactable > div.rt-table > div.rt-thead > div.rt-tr.rt-tr-group-header > div.rt-th-group:after {
  height: 0px !important;
}
</style>
<table class="gt_table" data-quarto-disable-processing="false" data-quarto-bootstrap="false">
...
<td headers="Stability_Higher" class="gt_row gt_right gt_striped">0.63</td></tr>
    <tr><td headers="Index" class="gt_row gt_left">Mea mu B</td>
<td headers="Feature" class="gt_row gt_left">Meaning_mu_Baseline</td>
<td headers="Lower" class="gt_row gt_center">1</td>
<td headers="Higher" class="gt_row gt_right">1</td>
<td headers="Stability_Lower" class="gt_row gt_right">0.84</td>
<td headers="Stability_Higher" class="gt_row gt_right">0.63</td></tr>
...
<td headers="Stability_Higher" class="gt_row gt_right gt_striped">0.61</td></tr>
...
<td headers="Stability_Higher" class="gt_row gt_right gt_striped">0.79</td></tr>
...
<td headers="Stability_Higher" class="gt_row gt_right">0.79</td></tr>
...
<td headers="Lower" class="gt_row gt_center">3</td>
<td headers="Higher" class="gt_row gt_right">1</td>
<td headers="Stability_Lower" class="gt_row gt_right">0.99</td>
<td headers="Stability_Higher" class="gt_row gt_right">0.57</td></tr>
...
<td headers="Higher" class="gt_row gt_right gt_striped">1</td>
<td headers="Stability_Lower" class="gt_row gt_right gt_striped">0.86</td>
<td headers="Stability_Higher" class="gt_row gt_right gt_striped">0.57</td></tr>
...
|:----------|:-------------------------------|-----:|------:|:---------------|:----------------|
|Bea mu B   |Beauty_mu_Baseline              |     1|      1|0.73            |0.63             |
|Val mu B   |Valence_mu_Baseline             |     1|      1|0.73            |0.63             |
|Mea mu B   |Meaning_mu_Baseline             |     1|      1|0.84            |0.63             |
|Mea p0 B   |Meaning_pzero_Baseline          |     1|      1|0.64            |0.61             |
|Wor mu B   |Worth_mu_Baseline               |     1|      1|0.94            |0.63             |
|Bea mu AI  |Beauty_mu_AI                    |     2|      1|0.90            |0.79             |
|Val mu AI  |Valence_mu_AI                   |     2|      1|0.90            |0.79             |
|Mea mu AI  |Meaning_mu_AI                   |     2|      1|0.87            |0.79             |
|Mea p0 AI  |Meaning_pzero_AI                |     2|      1|0.86            |0.78             |
|Wor mu F   |Worth_mu_Forgery                |     2|      1|0.58            |0.79             |
|Wor mu AI  |Worth_mu_AI                     |     2|      1|0.58            |0.79             |
...
|Mea phi B  |Meaning_phi_Baseline            |     3|      1|0.99            |0.57             |
|Wor disc B |Worth_disc_Baseline             |     3|      1|0.98            |0.57             |
|Bea cL B   |Beauty_confleft_Baseline        |     4|      1|0.86            |0.57             |
|Bea pL B   |Beauty_precleft_Baseline        |     4|      1|0.86            |0.57             |
...
```{=html}
<div id="qpoymhixkb" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>#qpoymhixkb table {
  font-family: system-ui, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji';
  -webkit-font-smoothing: antialiased;
  -moz-osx-font-smoothing: grayscale;
}

#qpoymhixkb thead, #qpoymhixkb tbody, #qpoymhixkb tfoot, #qpoymhixkb tr, #qpoymhixkb td, #qpoymhixkb th {
  border-style: none;
}
...
#qpoymhixkb .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D5D5D5;
}

#qpoymhixkb .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D5D5D5;
  border-bottom-style: solid;
...
#qpoymhixkb .gt_column_spanner_outer {
  color: #FFFFFF;
  background-color: #000000;
  font-size: 100%;
  font-weight: normal;
...
#qpoymhixkb .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#qpoymhixkb .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#qpoymhixkb .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D5D5D5;
  vertical-align: bottom;
...
#qpoymhixkb .gt_spanner_row {
  border-bottom-style: hidden;
}

#qpoymhixkb .gt_group_heading {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#qpoymhixkb .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#qpoymhixkb .gt_from_md > :first-child {
  margin-top: 0;
}

#qpoymhixkb .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#qpoymhixkb .gt_row_group_first td {
  border-top-width: 2px;
}

#qpoymhixkb .gt_row_group_first th {
  border-top-width: 2px;
}

#qpoymhixkb .gt_summary_row {
  color: #333333;
  background-color: #D5D5D5;
  text-transform: inherit;
  padding-top: 8px;
...
#qpoymhixkb .gt_first_summary_row {
  border-top-style: solid;
  border-top-color: #D5D5D5;
}

#qpoymhixkb .gt_first_summary_row.thick {
  border-top-width: 2px;
}

#qpoymhixkb .gt_last_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#qpoymhixkb .gt_grand_summary_row {
  color: #FFFFFF;
  background-color: #929292;
  text-transform: inherit;
  padding-top: 8px;
...
#qpoymhixkb .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#qpoymhixkb .gt_last_grand_summary_row_top {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#qpoymhixkb .gt_striped {
  background-color: #F4F4F4;
}

#qpoymhixkb .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D5D5D5;
  border-bottom-style: solid;
...
#qpoymhixkb .gt_font_normal {
  font-weight: normal;
}

#qpoymhixkb .gt_font_bold {
  font-weight: bold;
}

#qpoymhixkb .gt_font_italic {
  font-style: italic;
}
...
#qpoymhixkb .gt_footnote_marks {
  font-size: 75%;
  vertical-align: 0.4em;
  position: initial;
}

#qpoymhixkb .gt_asterisk {
  font-size: 100%;
  vertical-align: 0;
}

#qpoymhixkb .gt_indent_1 {
  text-indent: 5px;
}

#qpoymhixkb .gt_indent_2 {
  text-indent: 10px;
}

#qpoymhixkb .gt_indent_3 {
  text-indent: 15px;
}

#qpoymhixkb .gt_indent_4 {
  text-indent: 20px;
}

#qpoymhixkb .gt_indent_5 {
  text-indent: 25px;
}

#qpoymhixkb .katex-display {
  display: inline-flex !important;
  margin-bottom: 0.75em !important;
}

#qpoymhixkb div.Reactable > div.rt-table > div.rt-thead > div.rt-tr.rt-tr-group-header > div.rt-th-group:after {
  height: 0px !important;
}
</style>
<table class="gt_table" data-quarto-disable-processing="false" data-quarto-bootstrap="false">
...
<td headers="Frequency" class="gt_row gt_right gt_striped">0.096</td></tr>
    <tr><td headers="Order" class="gt_row gt_left">Lower</td>
<td headers="# of Factors" class="gt_row gt_right">8</td>
<td headers="Frequency" class="gt_row gt_right">0.224</td></tr>
    <tr><td headers="Order" class="gt_row gt_left gt_striped">Lower</td>
<td headers="# of Factors" class="gt_row gt_right gt_striped">9</td>
<td headers="Frequency" class="gt_row gt_right gt_striped">0.312</td></tr>
    <tr><td headers="Order" class="gt_row gt_left">Lower</td>
<td headers="# of Factors" class="gt_row gt_right">10</td>
<td headers="Frequency" class="gt_row gt_right">0.208</td></tr>
    <tr><td headers="Order" class="gt_row gt_left gt_striped">Lower</td>
<td headers="# of Factors" class="gt_row gt_right gt_striped">11</td>
<td headers="Frequency" class="gt_row gt_right gt_striped">0.122</td></tr>
    <tr><td headers="Order" class="gt_row gt_left">Lower</td>
...
<td headers="Frequency" class="gt_row gt_right">0.178</td></tr>
    <tr><td headers="Order" class="gt_row gt_left gt_striped">Higher</td>
<td headers="# of Factors" class="gt_row gt_right gt_striped">3</td>
<td headers="Frequency" class="gt_row gt_right gt_striped">0.556</td></tr>
    <tr><td headers="Order" class="gt_row gt_left">Higher</td>
...
```{.r .cell-code}
memory_models <- names(memory_info)
...
::: {.cell-output-display}
![Reliability (D-vour) of the memory indices, with 95% bootstrap CI. Dashed lines at .5 and .75.](5_correlates_files/figure-html/fig-memory-reliability-1.png){#fig-memory-reliability width=864}
:::
:::
...
::: {.cell-output-display}
![Correlations between the reliable memory indices (columns) and participant characteristics (220 participants), ordered within each group by the similarity of their correlation profiles. Bold: p < .05 (uncorrected); *: p < .05 after FDR correction across the whole table.](5_correlates_files/figure-html/fig-memory-correlates-1.png){#fig-memory-correlates width=1056}
:::
:::
...
indices (see Memory; 220 participants). Phase-2 scores are missing for the 7
participants without Phase-2 data.
...
fill_higher <- setNames(pal_higher[paste0("H", tree_higher$Higher)], tree_higher$Label)
...
|Row                                   |Aesthetic appraisal: Overall |Aesthetic appraisal: Aesthetic sensitivity |Aesthetic appraisal: Anti-fake bias |Aesthetic appraisal: Rating consistency |Aesthetic appraisal: Ugliness extremity |Realness beliefs: Overall |Realness beliefs: Realness tendency |Realness beliefs: Realness conviction |Realness beliefs: Fakeness conviction |
|:-------------------------------------|:----------------------------|:------------------------------------------|:-----------------------------------|:---------------------------------------|:---------------------------------------|:-------------------------|:-----------------------------------|:-------------------------------------|:-------------------------------------|
|Demographics: Age                     |-.15                         |-.10                                       |.13                                 |.03                                     |-.15                                    |.05                       |-.01                                |.05                                   |.05                                   |
|Demographics: Art expertise           |.11                          |.35*                                       |-.11                                |-.18*                                   |.08                                     |-.02                      |-.01                                |.00                                   |-.04                                  |
|Demographics: Education               |.07                          |.09                                        |-.03                                |.02                                     |.06                                     |-.12                      |.05                                 |-.10                                  |-.12                                  |
|Demographics: Gender (male)           |.15                          |.09                                        |.02                                 |.08                                     |.15                                     |.07                       |.07                                 |.05                                   |.07                                   |
|AI attitudes: AI attitudes (negative) |.12                          |.04                                        |-.36*                               |.07                                     |.09                                     |-.09                      |.00                                 |-.10                                  |-.07                                  |
|AI attitudes: Manipulation distrust   |.11                          |.14                                        |.02                                 |-.02                                    |.10                                     |-.01                      |.15                                 |.04                                   |-.07                                  |
|AI attitudes: AI art realism          |-.09                         |-.05                                       |.37*                                |-.05                                    |-.06                                    |.13                       |-.01                                |.13                                   |.12                                   |
|AI attitudes: AI knowledge            |.00                          |.29*                                       |.04                                 |-.23*                                   |-.01                                    |.11                       |.16                                 |.15                                   |.07                                   |
|AI attitudes: AI use                  |-.07                         |.16                                        |.08                                 |-.17*                                   |-.07                                    |.24*                      |.06                                 |.24*                                  |.21*                                  |
|AI attitudes: AI attitudes (positive) |-.03                         |.17*                                       |.25*                                |-.10                                    |-.03                                    |.23*                      |.06                                 |.23*                                  |.22*                                  |
|Imagery & mood: Visual imagery (VVIQ) |-.05                         |-.20*                                      |.12                                 |.11                                     |-.03                                    |-.10                      |-.05                                |-.11                                  |-.09                                  |
|Imagery & mood: Depression            |-.07                         |-.02                                       |-.07                                |-.04                                    |-.07                                    |-.04                      |.01                                 |-.03                                  |-.05                                  |
|Imagery & mood: Anxiety               |-.08                         |-.01                                       |-.03                                |-.12                                    |-.08                                    |.01                       |.02                                 |.03                                   |-.02                                  |
|Imagery & mood: Life satisfaction     |.02                          |.12                                        |.13                                 |-.02                                    |.01                                     |.04                       |.06                                 |.03                                   |.05                                   |
|Interoception: MINT SexS              |-.14                         |.14                                        |.02                                 |-.20*                                   |-.15                                    |.17*                      |.12                                 |.17*                                  |.15                                   |
|Interoception: MINT Derm              |-.05                         |.06                                        |-.10                                |-.15                                    |-.05                                    |.08                       |.07                                 |.10                                   |.06                                   |
|Interoception: MINT CaCo              |.02                          |.05                                        |-.09                                |-.04                                    |.01                                     |.01                       |-.07                                |.00                                   |.01                                   |
|Interoception: MINT Urin              |.01                          |.05                                        |.01                                 |-.03                                    |.01                                     |.02                       |.03                                 |.02                                   |.02                                   |
|Interoception: MINT ExAc              |-.04                         |.04                                        |.01                                 |-.06                                    |-.04                                    |.20*                      |.10                                 |.20*                                  |.17*                                  |
|Interoception: MINT Gast              |-.02                         |.14                                        |-.07                                |-.15                                    |-.03                                    |.23*                      |.07                                 |.24*                                  |.20*                                  |
|Interoception: MINT Card              |.03                          |.18*                                       |-.05                                |-.07                                    |.01                                     |.11                       |.10                                 |.13                                   |.08                                   |
|Interoception: MINT Sati              |.00                          |.05                                        |-.03                                |-.05                                    |-.00                                    |.13                       |.03                                 |.14                                   |.11                                   |
|Interoception: MINT Olfa              |.08                          |.06                                        |-.02                                |-.04                                    |.08                                     |.12                       |.03                                 |.11                                   |.13                                   |
|Interoception: MINT Resp              |.03                          |.18*                                       |-.01                                |-.07                                    |.01                                     |.19*                      |-.02                                |.19*                                  |.18*                                  |
|Interoception: MINT RelA              |.04                          |.21*                                       |.02                                 |-.07                                    |.02                                     |.19*                      |.09                                 |.21*                                  |.14                                   |
|Recognition: False alarms             |.15                          |.08                                        |-.07                                |-.04                                    |.16                                     |.07                       |-.01                                |.09                                   |.04                                   |
|Recognition: Hits                     |.13                          |.01                                        |-.08                                |.05                                     |.13                                     |.05                       |.06                                 |.09                                   |.01                                   |
|Recalled label: Human Original        |-.10                         |-.05                                       |-.02                                |-.00                                    |-.10                                    |.05                       |.06                                 |.07                                   |.03                                   |
|Recalled label: AI-Generated          |.02                          |.04                                        |.11                                 |-.04                                    |.03                                     |-.05                      |-.06                                |-.07                                  |-.03                                  |
|Recalled label: Human Forgery         |.10                          |.05                                        |-.08                                |.03                                     |.10                                     |.02                       |-.02                                |.02                                   |.02                                   |
|Recalled belief: AI Original          |-.03                         |-.16                                       |.02                                 |.13                                     |-.03                                    |-.18                      |-.13                                |-.20*                                 |-.14                                  |
|Recalled belief: AI Copy              |.06                          |-.04                                       |-.01                                |.01                                     |.07                                     |-.07                      |-.14                                |-.09                                  |-.05                                  |
|Recalled belief: Human Forgery        |-.02                         |.10                                        |-.07                                |-.16                                    |-.02                                    |.14                       |.02                                 |.16                                   |.12                                   |
|Recalled belief: Human Original       |.00                          |.08                                        |.00                                 |.04                                     |-.02                                    |.03                       |.18                                 |.06                                   |.00                                   |
...
```{.r .cell-code}
# Manuscript Figure 3. The legend of the matrix (top) also covers the correlates (bottom).
# free(): the matrix is not aligned with the heatmap's panels, so that it can use the full width
figure3 <- free(p_ega_matrix) /
...
ggsave("figures/figure3.png", figure3, width = 20, height = 33.9, dpi = 300, bg = "white")
```

::: {.cell-output-display}
![Structure and correlates of the participant-level indices. Top: correlations between the indices entering the EGA (lower half), their reliability (diagonal) and their hierarchical community structure (upper half). Bottom: correlations between the community scores and participant characteristics and follow-up memory indices.](5_correlates_files/figure-html/fig-figure3-1.png){#fig-figure3 fig-alt='Top: triangular correlation matrix of the participant-level indices with a tree of their lower- and higher-order communities drawn above the diagonal. Bottom: heatmap of correlations between the community scores and participant characteristics and memory indices.' width=1920}
:::
:::
