...
|Beauty2Reality |Beauty2Reality.rds |  4000|2026-09-26 11:02 |
|BeautySR       |BeautySR.rds       |  4000|2026-09-26 11:01 |
|MeaningSR      |MeaningSR.rds      |  4000|2026-09-26 11:01 |
...
traits <- c("Age" = "Demographics", "Gender (male)" = "Demographics", "Education" = "Demographics",
            ...
            "Self-relevance (mean)" = "Follow-up ratings", "Follow-up beauty (mean)" = "Follow-up ratings")
...
# Follow-up ratings as traits (2026-09-26): the participant's mean
# self-relevance (0-6) and mean follow-up beauty (0-1) over the 96 artworks
# of the memory session (220 participants). BeautySRBetween showed that
# people with a higher mean self-relevance rate art as more beautiful.
df_followup <- read.csv("../data/data_memory_task.csv") |>
  summarise(`Self-relevance (mean)` = mean(SelfRelevance * 6, na.rm = TRUE),
            `Follow-up beauty (mean)` = mean(Beauty2, na.rm = TRUE), .by = "Participant")
df_traits <- left_join(df_traits, df_followup, by = "Participant")
...
Slope indices come from the models with a within-participant covariate
(`mediation_info` entries with an `individual` field), per full range of the
covariate, averaged over the labels, on the link scale:

- **RealityBeauty `mu` Slope** (`5_realitydeterminants.qmd`): the slope of the
  syntheticness choice (`mu`, the probability of answering on the "Human"
  side) on the participant's own Phase-1 beauty: how strongly they take
  beauty as a sign of human authorship (the "beautiful = human" inference).
- **BeautySR `mu` Slope** and **MeaningSR `mu` / `pzero` Slope**
  (`6_selfrelevance.qmd`, added 2026-09-26): the slope of the Phase-1 beauty
  choice, and of meaningfulness and of its "not at all" answer, on the
  participant's own self-relevance (rated at follow-up): how much their
  aesthetic judgment tracks personal resonance (220 participants).
- **Beauty2Reality `mu` Slope** (`4_memory.qmd`, added 2026-09-26): the
  slope of the follow-up beauty choice on the participant's own Phase-2
  syntheticness belief, Phase-1 beauty held at their mean: how much a
  person's later appreciation follows the belief they had formed (217
  participants). Extracted as a check on its reliability: D-vour .22, so it
  does not reach the 1/3 threshold and stays out of the correlates, like
  MeaningSR's `pzero` slope (.20). BeautySR's (.39) and MeaningSR's `mu`
  slopes (.49) do enter.
...
- **SelfRelevance** (follow-up): a moderator of the label effect (RQ3) rather
  than an outcome of it; also 220 participants. Its participant *level* enters
  the correlates as a trait instead (mean self-relevance, with mean follow-up
  beauty), and its coupling with the Phase-1 ratings as the BeautySR / MeaningSR
  slopes above.
...
```{=html}
<div id="ghmshegxrh" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>#ghmshegxrh table {
  font-family: system-ui, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji';
  -webkit-font-smoothing: antialiased;
  -moz-osx-font-smoothing: grayscale;
}

#ghmshegxrh thead, #ghmshegxrh tbody, #ghmshegxrh tfoot, #ghmshegxrh tr, #ghmshegxrh td, #ghmshegxrh th {
  border-style: none;
}
...
#ghmshegxrh .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D5D5D5;
}

#ghmshegxrh .gt_col_headings {
  border-top-style: solid;
...
#ghmshegxrh .gt_column_spanner_outer {
  color: #FFFFFF;
  background-color: #000000;
  font-size: 100%;
  font-weight: normal;
...
#ghmshegxrh .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#ghmshegxrh .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#ghmshegxrh .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D5D5D5;
  vertical-align: bottom;
...
#ghmshegxrh .gt_spanner_row {
  border-bottom-style: hidden;
}

#ghmshegxrh .gt_group_heading {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#ghmshegxrh .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#ghmshegxrh .gt_from_md > :first-child {
  margin-top: 0;
}

#ghmshegxrh .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#ghmshegxrh .gt_row_group_first td {
  border-top-width: 2px;
}

#ghmshegxrh .gt_row_group_first th {
  border-top-width: 2px;
}

#ghmshegxrh .gt_summary_row {
  color: #333333;
...
#ghmshegxrh .gt_first_summary_row {
  border-top-style: solid;
  border-top-color: #D5D5D5;
}

#ghmshegxrh .gt_first_summary_row.thick {
  border-top-width: 2px;
}

#ghmshegxrh .gt_last_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#ghmshegxrh .gt_grand_summary_row {
  color: #FFFFFF;
...
#ghmshegxrh .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#ghmshegxrh .gt_last_grand_summary_row_top {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#ghmshegxrh .gt_striped {
  background-color: #F4F4F4;
}

#ghmshegxrh .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D5D5D5;
  border-bottom-style: solid;
...
#ghmshegxrh .gt_font_normal {
  font-weight: normal;
}

#ghmshegxrh .gt_font_bold {
  font-weight: bold;
}

#ghmshegxrh .gt_font_italic {
  font-style: italic;
}
...
#ghmshegxrh .gt_footnote_marks {
  font-size: 75%;
  vertical-align: 0.4em;
  position: initial;
}

#ghmshegxrh .gt_asterisk {
  font-size: 100%;
  vertical-align: 0;
}

#ghmshegxrh .gt_indent_1 {
  text-indent: 5px;
}

#ghmshegxrh .gt_indent_2 {
  text-indent: 10px;
}

#ghmshegxrh .gt_indent_3 {
  text-indent: 15px;
}

#ghmshegxrh .gt_indent_4 {
  text-indent: 20px;
}

#ghmshegxrh .gt_indent_5 {
  text-indent: 25px;
}

#ghmshegxrh .katex-display {
  display: inline-flex !important;
  margin-bottom: 0.75em !important;
}

#ghmshegxrh div.Reactable > div.rt-table > div.rt-thead > div.rt-tr.rt-tr-group-header > div.rt-th-group:after {
...
<td headers="Posterior_SD" class="gt_row gt_right">1.15</td></tr>
    <tr><td headers="Model" class="gt_row gt_center gt_striped">Beauty2Reality</td>
<td headers="Parameter" class="gt_row gt_center gt_striped">mu</td>
<td headers="Index" class="gt_row gt_center gt_striped">Slope</td>
<td headers="N" class="gt_row gt_right gt_striped">217</td>
<td headers="Average" class="gt_row gt_left gt_striped">0.73</td>
<td headers="Between_SD" class="gt_row gt_right gt_striped">0.32</td>
<td headers="Posterior_SD" class="gt_row gt_right gt_striped">0.62</td></tr>
    <tr><td headers="Model" class="gt_row gt_center">BeautySR</td>
<td headers="Parameter" class="gt_row gt_center">mu</td>
<td headers="Index" class="gt_row gt_center">Slope</td>
<td headers="N" class="gt_row gt_right">220</td>
<td headers="Average" class="gt_row gt_left">3.25</td>
<td headers="Between_SD" class="gt_row gt_right">1.06</td>
<td headers="Posterior_SD" class="gt_row gt_right">1.32</td></tr>
    <tr><td headers="Model" class="gt_row gt_center gt_striped">MeaningSR</td>
<td headers="Parameter" class="gt_row gt_center gt_striped">mu</td>
<td headers="Index" class="gt_row gt_center gt_striped">Slope</td>
<td headers="N" class="gt_row gt_right gt_striped">220</td>
<td headers="Average" class="gt_row gt_left gt_striped">0.52</td>
<td headers="Between_SD" class="gt_row gt_right gt_striped">0.44</td>
<td headers="Posterior_SD" class="gt_row gt_right gt_striped">0.44</td></tr>
    <tr><td headers="Model" class="gt_row gt_center">MeaningSR</td>
<td headers="Parameter" class="gt_row gt_center">pzero</td>
<td headers="Index" class="gt_row gt_center">Slope</td>
<td headers="N" class="gt_row gt_right">220</td>
<td headers="Average" class="gt_row gt_left">-1.62</td>
<td headers="Between_SD" class="gt_row gt_right">0.55</td>
<td headers="Posterior_SD" class="gt_row gt_right">1.09</td></tr>
  </tbody>
...
|Beauty2Reality |mu        |Slope    | 217|0.73      |0.32       |0.62         |
|BeautySR       |mu        |Slope    | 220|3.25      |1.06       |1.32         |
|MeaningSR      |mu        |Slope    | 220|0.52      |0.44       |0.44         |
|MeaningSR      |pzero     |Slope    | 220|-1.62     |0.55       |1.09         |
...
<td headers="Parameter" class="gt_row gt_center gt_striped">mu</td>
<td headers="Index" class="gt_row gt_center gt_striped">Slope</td>
<td headers="D_vour" class="gt_row gt_right gt_striped">0.22</td>
<td headers="CI_low" class="gt_row gt_right gt_striped">0.18</td>
<td headers="CI_high" class="gt_row gt_right gt_striped">0.25</td></tr>
    <tr><td headers="Model" class="gt_row gt_center">BeautySR</td>
<td headers="Parameter" class="gt_row gt_center">mu</td>
<td headers="Index" class="gt_row gt_center">Slope</td>
<td headers="D_vour" class="gt_row gt_right">0.39</td>
<td headers="CI_low" class="gt_row gt_right">0.35</td>
<td headers="CI_high" class="gt_row gt_right">0.44</td></tr>
    <tr><td headers="Model" class="gt_row gt_center gt_striped">MeaningSR</td>
<td headers="Parameter" class="gt_row gt_center gt_striped">mu</td>
<td headers="Index" class="gt_row gt_center gt_striped">Slope</td>
<td headers="D_vour" class="gt_row gt_right gt_striped">0.49</td>
<td headers="CI_low" class="gt_row gt_right gt_striped">0.44</td>
<td headers="CI_high" class="gt_row gt_right gt_striped">0.54</td></tr>
    <tr><td headers="Model" class="gt_row gt_center">MeaningSR</td>
<td headers="Parameter" class="gt_row gt_center">pzero</td>
<td headers="Index" class="gt_row gt_center">Slope</td>
<td headers="D_vour" class="gt_row gt_right">0.20</td>
...
|Beauty2Reality |mu        |Slope    |0.22   |0.18   |0.25    |
|BeautySR       |mu        |Slope    |0.39   |0.35   |0.44    |
|MeaningSR      |mu        |Slope    |0.49   |0.44   |0.54    |
|MeaningSR      |pzero     |Slope    |0.20   |0.17   |0.24    |
...
|Parameter1                      |Beauty_precleft_Baseline |Beauty_precleft_Forgery |Beauty_precright_AI |Beauty_precright_Baseline |Beauty_precright_Forgery |Worth_disc_Baseline |Valence_phi_Baseline |Meaning_phi_Baseline |Reality_precright_AI |Authenticity_precright_AI |Reality_mu_AI |Authenticity_mu_Forgery |Reality_confleft_Forgery |BeautySR_mu_Slope |MeaningSR_mu_Slope |Reality_precleft_AI |Authenticity_precleft_AI |RealityBeauty_mu_Slope |Beauty2Reality_mu_Slope |Beauty_confright_Baseline |Meaning_mu_Baseline |Worth_mu_Baseline |Beauty_mu_Baseline |Valence_mu_Baseline |Valence_phi_Forgery |Meaning_pzero_AI |MeaningSR_pzero_Slope |Reality_confleft_AI |Authenticity_confleft_AI |Authenticity_confright_AI |Reality_confright_AI |Reality_confright_Baseline |Authenticity_confright_Baseline |Reality_confleft_Baseline |Authenticity_confleft_Baseline |Authenticity_precleft_Forgery |Reality_precright_Forgery |Authenticity_precright_Forgery |Reality_precleft_Forgery |Reality_precright_Baseline |Authenticity_precright_Baseline |Reality_precleft_Baseline |Authenticity_precleft_Baseline |Beauty_precleft_AI |Valence_phi_AI |Meaning_phi_Forgery |Beauty_mu_Forgery |Valence_mu_Forgery |Reality_confright_Forgery |Authenticity_confright_Forgery |Beauty_confright_Forgery |Beauty_confright_AI |Beauty_mu_AI |Valence_mu_AI |Worth_mu_Forgery |Worth_mu_AI |Meaning_mu_Forgery |Meaning_mu_AI |Reality_mu_Baseline |Reality_mu_Forgery |Authenticity_mu_Baseline |Authenticity_mu_AI |Meaning_pzero_Forgery |Beauty_confleft_AI |Meaning_pzero_Baseline |Beauty_confleft_Baseline |Beauty_confleft_Forgery |Meaning_phi_AI |
|:-------------------------------|:------------------------|:-----------------------|:-------------------|:-------------------------|:------------------------|:-------------------|:--------------------|:--------------------|:--------------------|:-------------------------|:-------------|:-----------------------|:------------------------|:-----------------|:------------------|:-------------------|:------------------------|:----------------------|:-----------------------|:-------------------------|:-------------------|:-----------------|:------------------|:-------------------|:-------------------|:----------------|:---------------------|:-------------------|:------------------------|:-------------------------|:--------------------|:--------------------------|:-------------------------------|:-------------------------|:------------------------------|:-----------------------------|:-------------------------|:------------------------------|:------------------------|:--------------------------|:-------------------------------|:-------------------------|:------------------------------|:------------------|:--------------|:-------------------|:-----------------|:------------------|:-------------------------|:------------------------------|:------------------------|:-------------------|:------------|:-------------|:----------------|:-----------|:------------------|:-------------|:-------------------|:------------------|:------------------------|:------------------|:---------------------|:------------------|:----------------------|:------------------------|:-----------------------|:--------------|
|Beauty_precleft_Forgery         |.81                      |NA                      |NA                  |NA                        |NA                       |NA                  |NA                   |NA                   |NA                   |NA                        |NA            |NA                      |NA                       |NA                |NA                 |NA                  |NA                       |NA                     |NA                      |NA                        |NA                  |NA                |NA                 |NA                  |NA                  |NA               |NA                    |NA                  |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Beauty_precright_AI             |.18                      |.11                     |NA                  |NA                        |NA                       |NA                  |NA                   |NA                   |NA                   |NA                        |NA            |NA                      |NA                       |NA                |NA                 |NA                  |NA                       |NA                     |NA                      |NA                        |NA                  |NA                |NA                 |NA                  |NA                  |NA               |NA                    |NA                  |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Beauty_precright_Baseline       |.41                      |.32                     |.59                 |NA                        |NA                       |NA                  |NA                   |NA                   |NA                   |NA                        |NA            |NA                      |NA                       |NA                |NA                 |NA                  |NA                       |NA                     |NA                      |NA                        |NA                  |NA                |NA                 |NA                  |NA                  |NA               |NA                    |NA                  |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Beauty_precright_Forgery        |.36                      |.26                     |.50                 |.89                       |NA                       |NA                  |NA                   |NA                   |NA                   |NA                        |NA            |NA                      |NA                       |NA                |NA                 |NA                  |NA                       |NA                     |NA                      |NA                        |NA                  |NA                |NA                 |NA                  |NA                  |NA               |NA                    |NA                  |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Worth_disc_Baseline             |.18                      |.10                     |.21                 |.38                       |.32                      |NA                  |NA                   |NA                   |NA                   |NA                        |NA            |NA                      |NA                       |NA                |NA                 |NA                  |NA                       |NA                     |NA                      |NA                        |NA                  |NA                |NA                 |NA                  |NA                  |NA               |NA                    |NA                  |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Valence_phi_Baseline            |.32                      |.24                     |.30                 |.51                       |.45                      |.48                 |NA                   |NA                   |NA                   |NA                        |NA            |NA                      |NA                       |NA                |NA                 |NA                  |NA                       |NA                     |NA                      |NA                        |NA                  |NA                |NA                 |NA                  |NA                  |NA               |NA                    |NA                  |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Meaning_phi_Baseline            |.22                      |.14                     |.25                 |.45                       |.39                      |.37                 |.55                  |NA                   |NA                   |NA                        |NA            |NA                      |NA                       |NA                |NA                 |NA                  |NA                       |NA                     |NA                      |NA                        |NA                  |NA                |NA                 |NA                  |NA                  |NA               |NA                    |NA                  |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Reality_precright_AI            |.03                      |.10                     |-.05                |.00                       |.01                      |.07                 |.03                  |.04                  |NA                   |NA                        |NA            |NA                      |NA                       |NA                |NA                 |NA                  |NA                       |NA                     |NA                      |NA                        |NA                  |NA                |NA                 |NA                  |NA                  |NA               |NA                    |NA                  |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Authenticity_precright_AI       |.15                      |.21                     |-.02                |.04                       |-.00                     |-.01                |.09                  |-.02                 |.17                  |NA                        |NA            |NA                      |NA                       |NA                |NA                 |NA                  |NA                       |NA                     |NA                      |NA                        |NA                  |NA                |NA                 |NA                  |NA                  |NA               |NA                    |NA                  |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Reality_mu_AI                   |.05                      |.05                     |-.04                |.05                       |.06                      |.07                 |.09                  |.00                  |.02                  |.02                       |NA            |NA                      |NA                       |NA                |NA                 |NA                  |NA                       |NA                     |NA                      |NA                        |NA                  |NA                |NA                 |NA                  |NA                  |NA               |NA                    |NA                  |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Authenticity_mu_Forgery         |.02                      |.01                     |-.01                |-.03                      |-.04                     |-.00                |.02                  |-.00                 |.01                  |.09                       |.13           |NA                      |NA                       |NA                |NA                 |NA                  |NA                       |NA                     |NA                      |NA                        |NA                  |NA                |NA                 |NA                  |NA                  |NA               |NA                    |NA                  |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Reality_confleft_Forgery        |.03                      |.03                     |.01                 |-.00                      |.03                      |.06                 |.12                  |-.01                 |.02                  |.04                       |.07           |.07                     |NA                       |NA                |NA                 |NA                  |NA                       |NA                     |NA                      |NA                        |NA                  |NA                |NA                 |NA                  |NA                  |NA               |NA                    |NA                  |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|BeautySR_mu_Slope               |-.01                     |.02                     |.06                 |.14                       |.17                      |-.00                |.10                  |.15                  |.08                  |-.04                      |-.03          |-.05                    |.12                      |NA                |NA                 |NA                  |NA                       |NA                     |NA                      |NA                        |NA                  |NA                |NA                 |NA                  |NA                  |NA               |NA                    |NA                  |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|MeaningSR_mu_Slope              |-.05                     |-.01                    |-.01                |-.04                      |-.00                     |-.12                |-.13                 |-.06                 |-.07                 |-.12                      |.02           |-.10                    |.12                      |.28               |NA                 |NA                  |NA                       |NA                     |NA                      |NA                        |NA                  |NA                |NA                 |NA                  |NA                  |NA               |NA                    |NA                  |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Reality_precleft_AI             |-.10                     |-.05                    |.06                 |-.05                      |-.05                     |-.06                |-.09                 |-.05                 |.07                  |-.02                      |.03           |-.00                    |.08                      |-.05              |-.08               |NA                  |NA                       |NA                     |NA                      |NA                        |NA                  |NA                |NA                 |NA                  |NA                  |NA               |NA                    |NA                  |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Authenticity_precleft_AI        |-.04                     |-.04                    |.10                 |.04                       |.05                      |.03                 |-.02                 |-.01                 |.11                  |-.09                      |.08           |.05                     |.06                      |-.10              |.12                |.23                 |NA                       |NA                     |NA                      |NA                        |NA                  |NA                |NA                 |NA                  |NA                  |NA               |NA                    |NA                  |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|RealityBeauty_mu_Slope          |-.06                     |-.07                    |.01                 |-.02                      |-.04                     |.02                 |.01                  |.03                  |-.06                 |-.03                      |-.17          |-.06                    |-.04                     |.13               |.16                |.00                 |.06                      |NA                     |NA                      |NA                        |NA                  |NA                |NA                 |NA                  |NA                  |NA               |NA                    |NA                  |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Beauty2Reality_mu_Slope         |-.00                     |.06                     |.06                 |-.02                      |-.03                     |-.13                |.13                  |.12                  |.09                  |-.00                      |-.01          |-.05                    |-.01                     |.11               |.03                |.15                 |.05                      |.14                    |NA                      |NA                        |NA                  |NA                |NA                 |NA                  |NA                  |NA               |NA                    |NA                  |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Beauty_confright_Baseline       |-.12                     |-.09                    |-.46                |-.61                      |-.59                     |-.39                |-.56                 |-.43                 |-.02                 |.04                       |-.13          |-.00                    |-.02                     |-.25              |-.03               |.01                 |.01                      |-.07                   |-.05                    |NA                        |NA                  |NA                |NA                 |NA                  |NA                  |NA               |NA                    |NA                  |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Meaning_mu_Baseline             |.07                      |.11                     |-.23                |-.29                      |-.29                     |-.19                |-.34                 |-.10                 |.01                  |.06                       |-.09          |-.05                    |-.00                     |-.26              |-.10               |-.03                |-.01                     |-.11                   |.07                     |.60                       |NA                  |NA                |NA                 |NA                  |NA                  |NA               |NA                    |NA                  |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Worth_mu_Baseline               |.18                      |.16                     |-.17                |-.15                      |-.19                     |-.16                |-.26                 |-.13                 |-.05                 |.10                       |-.08          |.00                     |-.01                     |-.37              |-.01               |.01                 |-.02                     |.02                    |.00                     |.41                       |.51                 |NA                |NA                 |NA                  |NA                  |NA               |NA                    |NA                  |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Beauty_mu_Baseline              |.15                      |.15                     |-.14                |-.15                      |-.15                     |-.09                |-.01                 |.09                  |.08                  |.10                       |-.10          |-.04                    |-.06                     |-.30              |-.11               |.00                 |-.06                     |.01                    |.16                     |.45                       |.55                 |.47               |NA                 |NA                  |NA                  |NA               |NA                    |NA                  |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Valence_mu_Baseline             |.18                      |.15                     |-.13                |-.12                      |-.15                     |-.02                |-.02                 |.06                  |.02                  |.07                       |-.05          |-.05                    |-.02                     |-.28              |.00                |-.02                |-.05                     |-.05                   |.07                     |.45                       |.56                 |.51               |.74                |NA                  |NA                  |NA               |NA                    |NA                  |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Valence_phi_Forgery             |.02                      |.07                     |-.01                |-.06                      |-.01                     |-.06                |-.04                 |-.04                 |-.05                 |-.05                      |.07           |-.04                    |.04                      |.00               |.05                |.02                 |-.04                     |.02                    |-.03                    |.03                       |.08                 |.11               |.00                |.11                 |NA                  |NA               |NA                    |NA                  |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Meaning_pzero_AI                |.02                      |.07                     |-.06                |-.01                      |.05                      |-.11                |.05                  |-.03                 |.04                  |-.02                      |-.02          |.06                     |-.04                     |.10               |-.00               |-.04                |-.03                     |.03                    |-.01                    |.01                       |-.00                |.05               |.09                |.05                 |.15                 |NA               |NA                    |NA                  |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|MeaningSR_pzero_Slope           |.19                      |.17                     |-.03                |-.04                      |-.03                     |.04                 |.09                  |.03                  |-.02                 |.07                       |-.11          |.01                     |-.07                     |-.33              |-.16               |-.04                |-.03                     |-.11                   |.04                     |.18                       |.28                 |.26               |.32                |.34                 |.07                 |.40              |NA                    |NA                  |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Reality_confleft_AI             |-.02                     |-.03                    |.00                 |.05                       |.05                      |.02                 |.05                  |.06                  |.03                  |-.05                      |-.04          |.01                     |-.55                     |-.09              |-.15               |-.08                |-.08                     |-.07                   |-.07                    |-.01                      |.01                 |.04               |.13                |.08                 |-.02                |.03              |.11                   |NA                  |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Authenticity_confleft_AI        |-.07                     |-.04                    |-.01                |-.04                      |-.00                     |-.01                |-.11                 |-.08                 |-.06                 |.06                       |-.00          |.11                     |-.25                     |-.09              |-.12               |-.06                |.10                      |-.04                   |.00                     |.16                       |.10                 |.06               |.06                |.11                 |-.02                |-.03             |.04                   |.19                 |NA                       |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Authenticity_confright_AI       |.07                      |.02                     |-.07                |-.11                      |-.10                     |-.08                |-.18                 |-.18                 |-.10                 |.04                       |.03           |-.11                    |-.14                     |-.15              |-.16               |-.01                |.00                      |-.03                   |-.10                    |.24                       |.11                 |.07               |.01                |.07                 |-.05                |-.03             |.01                   |.11                 |.28                      |NA                        |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Reality_confright_AI            |-.03                     |-.04                    |-.13                |-.20                      |-.20                     |-.11                |-.26                 |-.23                 |-.07                 |.04                       |-.05          |-.13                    |-.15                     |-.16              |-.16               |.01                 |.06                      |-.03                   |-.04                    |.32                       |.13                 |.12               |.06                |.12                 |-.08                |-.04             |.02                   |.02                 |.39                      |.69                       |NA                   |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Reality_confright_Baseline      |-.07                     |-.07                    |-.12                |-.22                      |-.23                     |-.19                |-.33                 |-.28                 |-.13                 |.04                       |-.10          |-.10                    |-.21                     |-.19              |-.11               |.00                 |.04                      |-.01                   |-.06                    |.37                       |.16                 |.15               |.03                |.12                 |-.07                |-.06             |-.01                  |.04                 |.46                      |.63                       |.83                  |NA                         |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Authenticity_confright_Baseline |-.05                     |-.07                    |-.14                |-.21                      |-.21                     |-.19                |-.32                 |-.27                 |-.12                 |.05                       |-.07          |-.12                    |-.20                     |-.24              |-.13               |-.01                |.00                      |-.06                   |-.04                    |.35                       |.19                 |.15               |.02                |.11                 |-.08                |-.12             |-.02                  |.06                 |.46                      |.70                       |.77                  |.93                        |NA                              |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Reality_confleft_Baseline       |-.10                     |-.08                    |-.13                |-.21                      |-.21                     |-.13                |-.33                 |-.28                 |-.18                 |-.01                      |-.07          |-.03                    |-.21                     |-.19              |-.12               |-.01                |.07                      |-.01                   |-.11                    |.30                       |.11                 |.12               |-.05               |.05                 |-.04                |-.06             |.02                   |.03                 |.49                      |.57                       |.70                  |.84                        |.82                             |NA                        |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Authenticity_confleft_Baseline  |-.08                     |-.10                    |-.11                |-.17                      |-.15                     |-.16                |-.30                 |-.25                 |-.14                 |.05                       |-.04          |.04                     |-.18                     |-.19              |-.13               |.00                 |.05                      |-.04                   |-.09                    |.28                       |.13                 |.13               |.00                |.07                 |-.06                |-.03             |.07                   |.05                 |.56                      |.57                       |.70                  |.84                        |.85                             |.88                       |NA                             |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Authenticity_precleft_Forgery   |.11                      |.10                     |.01                 |.07                       |.06                      |.06                 |.11                  |.03                  |-.01                 |.03                       |.07           |-.03                    |.02                      |-.02              |-.07               |-.18                |-.25                     |.02                    |-.02                    |-.06                      |.03                 |-.05              |.10                |.03                 |.08                 |.01              |.01                   |-.05                |-.01                     |-.02                      |-.02                 |-.02                       |-.03                            |-.01                      |.00                            |NA                            |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Reality_precright_Forgery       |.04                      |.01                     |.02                 |-.04                      |-.01                     |-.10                |.01                  |-.01                 |-.54                 |.01                       |.05           |.05                     |-.06                     |-.09              |-.10               |-.07                |-.13                     |-.01                   |-.06                    |.06                       |.12                 |.10               |.06                |.11                 |.05                 |.02              |.04                   |-.01                |.09                      |.10                       |.07                  |.09                        |.14                             |.12                       |.14                            |.14                           |NA                        |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Authenticity_precright_Forgery  |.13                      |.09                     |.09                 |.13                       |.12                      |.05                 |.10                  |.09                  |-.03                 |-.04                      |.07           |-.00                    |.09                      |-.08              |-.09               |-.08                |-.02                     |-.02                   |-.02                    |-.05                      |-.04                |-.07              |.05                |.08                 |.01                 |-.10             |-.02                  |-.01                |.11                      |-.01                      |.02                  |-.00                       |.03                             |.04                       |.08                            |.17                           |.21                       |NA                             |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Reality_precleft_Forgery        |.17                      |.13                     |-.02                |.12                       |.12                      |.08                 |.14                  |.04                  |-.12                 |.10                       |.00           |-.05                    |-.03                     |-.10              |-.04               |-.51                |-.10                     |-.03                   |-.10                    |-.02                      |.02                 |.05               |.04                |.05                 |-.05                |-.01             |.11                   |.02                 |.08                      |.11                       |.07                  |.09                        |.09                             |.07                       |.09                            |.23                           |.17                       |.22                            |NA                       |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Reality_precright_Baseline      |.17                      |.18                     |.05                 |.20                       |.16                      |.11                 |.17                  |.13                  |-.05                 |.31                       |.00           |-.02                    |.01                      |-.08              |-.13               |-.16                |-.09                     |-.02                   |-.06                    |-.07                      |.04                 |.03               |.13                |.11                 |-.08                |-.01             |.01                   |-.00                |.13                      |.12                       |.11                  |.11                        |.12                             |.09                       |.17                            |.21                           |.28                       |.40                            |.41                      |NA                         |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Authenticity_precright_Baseline |.16                      |.17                     |.02                 |.16                       |.13                      |.11                 |.20                  |.16                  |-.00                 |.34                       |.06           |-.02                    |.09                      |-.05              |-.16               |-.11                |-.16                     |-.07                   |-.03                    |-.08                      |-.01                |-.01              |.12                |.09                 |-.06                |-.05             |-.01                  |-.02                |.13                      |.05                       |.08                  |.04                        |.07                             |.04                       |.13                            |.23                           |.20                       |.58                            |.39                      |.83                        |NA                              |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Reality_precleft_Baseline       |.21                      |.21                     |.03                 |.21                       |.18                      |.00                 |.11                  |.08                  |-.05                 |.30                       |.02           |-.07                    |.03                      |-.02              |-.04               |-.19                |-.07                     |-.04                   |-.06                    |-.03                      |.02                 |.04               |.04                |.08                 |.02                 |-.02             |.03                   |-.03                |.13                      |.16                       |.14                  |.19                        |.20                             |.12                       |.20                            |.17                           |.22                       |.33                            |.60                      |.69                        |.65                             |NA                        |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Authenticity_precleft_Baseline  |.23                      |.23                     |-.02                |.17                       |.15                      |.04                 |.17                  |.10                  |.03                  |.28                       |.06           |-.08                    |-.03                     |.01               |-.13               |-.09                |-.23                     |-.06                   |-.02                    |-.08                      |-.00                |.02               |.14                |.11                 |.02                 |-.05             |-.01                  |-.03                |.05                      |.06                       |.02                  |.01                        |.05                             |-.04                      |.03                            |.22                           |.23                       |.32                            |.41                      |.63                        |.67                             |.68                       |NA                             |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Beauty_precleft_AI              |-.09                     |-.21                    |.02                 |-.04                      |-.04                     |.10                 |-.02                 |-.01                 |.01                  |-.05                      |.01           |-.00                    |-.01                     |.02               |-.06               |-.04                |-.07                     |-.04                   |-.05                    |.08                       |-.02                |-.10              |-.04               |-.02                |-.03                |-.12             |-.06                  |.04                 |-.03                     |.00                       |-.01                 |.02                        |.03                             |.03                       |.03                            |.07                           |-.03                      |.13                            |.12                      |.03                        |.06                             |.09                       |.01                            |NA                 |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Valence_phi_AI                  |.07                      |.04                     |.11                 |-.06                      |-.07                     |-.04                |.06                  |.01                  |-.03                 |.05                       |-.02          |-.01                    |.09                      |.05               |.02                |.07                 |.07                      |-.13                   |.07                     |.07                       |.06                 |-.02              |.02                |.00                 |.02                 |-.13             |.06                   |-.01                |.05                      |-.00                      |.04                  |.02                        |.02                             |.03                       |.03                            |.05                           |.10                       |.07                            |.02                      |.05                        |.05                             |.09                       |.00                            |.15                |NA             |NA                  |NA                |NA                 |NA                        |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Meaning_phi_Forgery             |.12                      |.11                     |.12                 |.04                       |.10                      |-.01                |.10                  |.10                  |-.05                 |.01                       |-.12          |-.07                    |-.02                     |.02               |.03                |-.08                |.04                      |-.07                   |.07                     |-.03                      |-.09                |-.00              |-.00               |.02                 |.05                 |-.00             |.05                   |.05                 |-.05                     |.02                       |-.03                 |-.01                       |-.01                            |-.03                      |-.06                           |-.00                          |.04                       |.06                            |.11                      |.10                        |.10                             |.10                       |-.00                           |.11                |.17            |NA                  |NA                |NA                 |NA                        |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Beauty_mu_Forgery               |-.00                     |-.03                    |.07                 |.04                       |.05                      |.06                 |.11                  |-.04                 |-.06                 |.03                       |.00           |.02                     |-.04                     |-.13              |-.16               |.01                 |-.01                     |-.17                   |-.07                    |-.09                      |-.12                |-.16              |-.27               |-.20                |.01                 |-.04             |-.04                  |.03                 |.00                      |.03                       |-.02                 |-.02                       |-.03                            |-.03                      |-.02                           |-.05                          |.05                       |.08                            |.03                      |.02                        |.02                             |.03                       |.05                            |-.03               |.02            |.08                 |NA                |NA                 |NA                        |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Valence_mu_Forgery              |.03                      |.04                     |-.01                |.08                       |.06                      |.02                 |.17                  |.13                  |-.00                 |.01                       |-.06          |.08                     |-.01                     |.01               |-.10               |.03                 |.05                      |-.06                   |.06                     |-.16                      |-.21                |-.23              |-.15               |-.27                |-.01                |-.03             |-.02                  |.05                 |-.05                     |-.02                      |-.00                 |-.06                       |-.08                            |-.09                      |-.07                           |-.02                          |-.06                      |.09                            |.10                      |.11                        |.08                             |.13                       |.09                            |.05                |.13            |.12                 |.51               |NA                 |NA                        |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Reality_confright_Forgery       |.02                      |.04                     |.02                 |.10                       |.12                      |.08                 |.20                  |.14                  |-.04                 |-.04                      |.03           |.19                     |.08                      |-.04              |-.05               |.01                 |-.07                     |-.03                   |.06                     |-.19                      |-.07                |-.09              |.01                |-.04                |-.01                |-.04             |.10                   |-.03                |-.18                     |-.44                      |-.54                 |-.46                       |-.42                            |-.36                      |-.34                           |.04                           |.05                       |.01                            |-.04                     |.03                        |.05                             |-.01                      |.04                            |.02                |.03            |.08                 |.10               |.15                |NA                        |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Authenticity_confright_Forgery  |-.06                     |-.06                    |-.04                |-.07                      |-.07                     |-.05                |-.06                 |-.06                 |-.04                 |-.03                      |-.05          |.10                     |.02                      |-.09              |.06                |-.02                |.01                      |-.06                   |.03                     |.06                       |-.02                |.04               |.02                |.02                 |-.06                |-.08             |.05                   |.01                 |.09                      |-.33                      |-.05                 |.11                        |.13                             |.10                       |.15                            |-.06                          |-.02                      |.13                            |.02                      |-.02                       |.07                             |.01                       |-.01                           |.09                |.05            |.05                 |.10               |.12                |.26                       |NA                             |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Beauty_confright_Forgery        |-.06                     |-.03                    |-.32                |-.28                      |-.31                     |-.15                |-.32                 |-.18                 |.02                  |.09                       |-.11          |.01                     |.02                      |-.09              |-.08               |.04                 |.02                      |-.03                   |-.13                    |.49                       |.26                 |.19               |.22                |.20                 |-.12                |-.04             |-.02                  |-.03                |.05                      |.12                       |.20                  |.22                        |.22                             |.13                       |.13                            |-.08                          |-.04                      |-.02                           |-.04                     |-.01                       |-.03                            |-.01                      |.06                            |.03                |-.04           |-.11                |-.05              |.22                |-.01                      |.13                            |NA                       |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Beauty_confright_AI             |.07                      |.06                     |-.10                |.16                       |.14                      |.15                 |.00                  |.13                  |.05                  |.08                       |.01           |.00                     |-.04                     |.07               |-.09               |.04                 |-.00                     |.06                    |-.01                    |-.11                      |-.08                |-.04              |-.07               |-.07                |-.06                |-.16             |-.15                  |.01                 |.01                      |-.01                      |.04                  |-.01                       |.00                             |-.03                      |-.03                           |-.03                          |-.17                      |-.03                           |-.01                     |.06                        |.03                             |.02                       |.08                            |.02                |-.24           |-.08                |-.03              |.20                |.00                       |.01                            |.45                      |NA                  |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Beauty_mu_AI                    |-.01                     |-.04                    |.02                 |.03                       |-.01                     |.09                 |-.00                 |.00                  |-.01                 |-.02                      |.13           |.04                     |.10                      |-.25              |-.02               |.05                 |.00                      |-.18                   |.06                     |.03                       |.05                 |-.00              |-.01               |.04                 |-.10                |-.31             |-.02                  |.00                 |.03                      |.10                       |.10                  |.07                        |.09                             |.05                       |.02                            |-.02                          |-.09                      |.03                            |-.03                     |-.04                       |.00                             |-.01                      |-.04                           |.03                |.09            |-.00                |.04               |.01                |.01                       |-.05                           |.04                      |.05                 |NA           |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Valence_mu_AI                   |-.02                     |-.03                    |-.04                |.06                       |.05                      |.11                 |.15                  |.09                  |-.00                 |-.05                      |.06           |.02                     |.07                      |-.04              |-.12               |.04                 |.08                      |-.14                   |.11                     |-.12                      |-.09                |-.21              |-.07               |-.15                |-.08                |-.37             |-.11                  |.04                 |.06                      |.04                       |.06                  |.01                        |.02                             |.01                       |.00                            |.04                           |-.11                      |.04                            |-.02                     |.03                        |.01                             |.02                       |.01                            |.07                |.21            |.03                 |.17               |.44                |.09                       |.03                            |.10                      |.29                 |.53          |NA            |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Worth_mu_Forgery                |-.08                     |-.04                    |-.02                |.03                       |.03                      |.20                 |.05                  |.09                  |.00                  |-.03                      |.02           |.03                     |.07                      |-.06              |-.07               |.05                 |.04                      |-.07                   |-.06                    |-.11                      |-.20                |-.32              |-.13               |-.11                |-.12                |-.18             |-.08                  |-.02                |.01                      |-.02                      |-.02                 |-.05                       |-.04                            |-.05                      |-.06                           |.01                           |-.04                      |.15                            |.05                      |.03                        |.05                             |.05                       |.07                            |.05                |.06            |.06                 |.37               |.52                |.20                       |.17                            |.31                      |.28                 |.16          |.33           |NA               |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Worth_mu_AI                     |-.05                     |-.04                    |.01                 |.09                       |.07                      |.26                 |.03                  |.07                  |-.03                 |-.06                      |.11           |.00                     |.05                      |-.04              |-.01               |.04                 |.08                      |-.08                   |-.11                    |-.16                      |-.16                |-.34              |-.19               |-.11                |-.10                |-.42             |-.22                  |-.04                |.07                      |.04                       |.05                  |.00                        |.04                             |.06                       |-.00                           |.01                           |-.08                      |.10                            |.01                      |.02                        |.02                             |-.00                      |-.01                           |.07                |.03            |.02                 |.14               |.26                |.10                       |.08                            |.17                      |.41                 |.38          |.57           |.72              |NA          |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Meaning_mu_Forgery              |.03                      |.00                     |-.09                |-.03                      |-.03                     |-.02                |.02                  |.09                  |-.03                 |.04                       |.03           |-.01                    |-.01                     |-.14              |-.06               |.01                 |.10                      |-.09                   |-.07                    |-.00                      |-.14                |-.12              |-.05               |-.09                |-.14                |-.17             |.01                   |.01                 |.04                      |.06                       |.05                  |.03                        |.04                             |-.02                      |.00                            |-.03                          |.02                       |.12                            |.16                      |.12                        |.13                             |.15                       |.15                            |-.03               |.07            |.28                 |.28               |.47                |.04                       |.12                            |.27                      |.11                 |.15          |.29           |.50              |.33         |NA                 |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Meaning_mu_AI                   |.00                      |-.02                    |-.07                |.02                       |.03                      |.02                 |-.03                 |.04                  |-.03                 |.03                       |.06           |-.02                    |.02                      |-.11              |-.06               |.04                 |.10                      |-.02                   |-.08                    |-.06                      |-.07                |-.12              |-.06               |-.06                |-.11                |-.30             |-.06                  |.04                 |.10                      |.08                       |.10                  |.06                        |.08                             |.08                       |.06                            |-.08                          |-.10                      |.09                            |.05                      |.07                        |.06                             |.03                       |.02                            |-.08               |.01            |.06                 |.08               |.20                |.02                       |.05                            |.14                      |.25                 |.34          |.45           |.34              |.50         |.60                |NA            |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Reality_mu_Baseline             |.07                      |.07                     |.01                 |-.02                      |-.05                     |-.10                |-.05                 |-.01                 |-.00                 |.00                       |-.33          |-.11                    |-.03                     |-.07              |-.04               |-.06                |-.05                     |-.02                   |-.01                    |.11                       |.11                 |.19               |.21                |.16                 |-.07                |.12              |.15                   |.03                 |-.13                     |-.01                      |.09                  |.10                        |.03                             |-.13                      |-.07                           |-.00                          |-.03                      |.01                            |.07                      |-.00                       |-.03                            |.03                       |.05                            |-.07               |.03            |.06                 |-.04              |.03                |-.04                      |-.02                           |.12                      |-.07                |.03          |-.04          |-.01             |-.16        |.04                |-.10          |NA                  |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Reality_mu_Forgery              |.08                      |.06                     |.07                 |.03                       |.02                      |-.17                |-.01                 |.03                  |-.06                 |-.07                      |-.26          |.05                     |-.06                     |.06               |-.02               |-.04                |-.14                     |-.18                   |.09                     |.03                       |.03                 |.10               |.14                |.10                 |-.09                |-.00             |.08                   |.08                 |-.06                     |-.05                      |.05                  |.06                        |.03                             |-.09                      |-.01                           |-.05                          |-.01                      |.13                            |.13                      |.06                        |.08                             |.06                       |.10                            |.03                |.05            |.07                 |.03               |.11                |-.04                      |.07                            |.04                      |-.08                |.03          |.01           |.04              |-.10        |.07                |-.05          |.59                 |NA                 |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Authenticity_mu_Baseline        |.04                      |.02                     |-.03                |.00                       |-.00                     |-.01                |-.06                 |.05                  |.01                  |-.09                      |-.21          |-.73                    |-.13                     |.04               |-.01               |.01                 |-.10                     |.05                    |.09                     |.03                       |.06                 |-.02              |.04                |.06                 |-.02                |-.15             |-.03                  |-.00                |-.08                     |.14                       |.14                  |.10                        |.15                             |.02                       |-.07                           |.00                           |-.03                      |-.00                           |.06                      |.03                        |.03                             |.08                       |.11                            |-.01               |.01            |.03                 |.05               |.00                |-.09                      |-.09                           |.06                      |.05                 |-.02         |.03           |.05              |.05         |.05                |.05           |.18                 |.09                |NA                       |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Authenticity_mu_AI              |.00                      |.02                     |-.01                |-.01                      |.02                      |-.10                |-.00                 |.05                  |.04                  |-.05                      |.18           |-.24                    |-.01                     |-.01              |-.09               |.02                 |-.01                     |-.08                   |.06                     |.00                       |.01                 |.04               |.09                |.03                 |-.10                |-.06             |.03                   |.04                 |-.10                     |.02                       |.06                  |-.00                       |.01                             |-.04                      |-.06                           |-.07                          |-.01                      |-.00                           |.02                      |.02                        |-.01                            |.02                       |.08                            |-.04               |.05            |.09                 |-.02              |.06                |-.02                      |-.05                           |.08                      |-.01                |.01          |.09           |-.03             |-.04        |.14                |.07           |.08                 |.15                |.24                      |NA                 |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Meaning_pzero_Forgery           |-.13                     |-.13                    |-.02                |.01                       |.04                      |.05                 |-.07                 |-.06                 |-.02                 |-.01                      |.00           |.03                     |.02                      |.07               |.16                |-.08                |.00                      |-.00                   |-.12                    |-.06                      |-.14                |-.09              |-.25               |-.17                |-.08                |-.27             |-.29                  |.01                 |-.03                     |-.07                      |-.02                 |.01                        |.01                             |.00                       |-.02                           |-.11                          |-.05                      |-.01                           |.03                      |-.01                       |-.02                            |-.02                      |-.02                           |.00                |-.10           |.01                 |-.13              |-.21               |-.05                      |-.00                           |-.05                     |.08                 |.04          |-.05          |-.11             |.09         |-.05               |.03           |-.03                |-.07               |-.00                     |-.10               |NA                    |NA                 |NA                     |NA                       |NA                      |NA             |
|Beauty_confleft_AI              |-.34                     |-.19                    |-.13                |-.18                      |-.11                     |-.13                |-.28                 |-.24                 |-.10                 |-.05                      |-.09          |-.02                    |.00                      |.02               |.02                |.09                 |.01                      |.06                    |-.08                    |.16                       |-.08                |-.05              |-.22               |-.19                |-.01                |.21              |.04                   |-.15                |.04                      |.06                       |.08                  |.14                        |.11                             |.22                       |.19                            |-.05                          |-.03                      |-.11                           |-.10                     |-.08                       |-.11                            |-.08                      |-.13                           |-.05               |-.25           |-.07                |.01               |-.09               |-.04                      |.05                            |.11                      |.03                 |-.09         |-.27          |-.04             |-.18        |-.06               |-.13          |-.10                |-.03               |-.03                     |-.03               |.07                   |NA                 |NA                     |NA                       |NA                      |NA             |
|Meaning_pzero_Baseline          |-.39                     |-.29                    |-.08                |-.16                      |-.13                     |-.17                |-.10                 |-.32                 |.02                  |-.07                      |.01           |.06                     |-.08                     |.23               |.03                |.02                 |-.06                     |.04                    |-.05                    |-.07                      |-.44                |-.38              |-.39               |-.41                |.02                 |.00              |-.39                  |.05                 |.06                      |.04                       |.03                  |.10                        |.09                             |.18                       |.14                            |-.06                          |-.04                      |-.07                           |-.08                     |-.20                       |-.15                            |-.17                      |-.14                           |.08                |.11            |-.03                |.08               |.09                |-.05                      |.07                            |-.07                     |-.09                |-.07         |.03           |.06              |-.02        |-.01               |-.10          |-.11                |-.07               |-.11                     |-.07               |.15                   |.30                |NA                     |NA                       |NA                      |NA             |
|Beauty_confleft_Baseline        |-.56                     |-.45                    |-.23                |-.35                      |-.26                     |-.26                |-.49                 |-.41                 |-.11                 |-.08                      |-.07          |.00                     |-.05                     |.14               |.03                |.00                 |.02                      |-.01                   |-.16                    |.28                       |-.06                |-.16              |-.37               |-.36                |-.01                |.00              |-.21                  |-.05                |.12                      |.15                       |.17                  |.22                        |.19                             |.29                       |.25                            |-.04                          |-.04                      |-.08                           |-.07                     |-.13                       |-.15                            |-.10                      |-.17                           |.11                |-.05           |-.08                |.09               |.02                |-.13                      |.03                            |.17                      |.04                 |-.05         |-.03          |.05              |.02         |.01                |-.01          |-.11                |-.06               |-.02                     |-.07               |.12                   |.63                |.45                    |NA                       |NA                      |NA             |
|Beauty_confleft_Forgery         |-.41                     |-.37                    |-.16                |-.17                      |-.11                     |-.13                |-.20                 |-.25                 |-.03                 |-.03                      |-.04          |.07                     |-.00                     |.22               |.07                |-.04                |.00                      |-.12                   |-.16                    |.10                       |-.14                |-.23              |-.33               |-.29                |-.11                |-.02             |-.21                  |-.00                |.07                      |.11                       |.14                  |.16                        |.13                             |.17                       |.17                            |-.12                          |-.10                      |-.11                           |-.07                     |-.14                       |-.12                            |-.13                      |-.16                           |.04                |-.02           |-.12                |.17               |-.05               |-.12                      |.02                            |.08                      |.07                 |.01          |.05           |.04              |.07         |-.03               |-.03          |-.09                |-.05               |-.07                     |-.05               |.26                   |.38                |.41                    |.64                      |NA                      |NA             |
|Meaning_phi_AI                  |-.15                     |-.11                    |-.04                |-.27                      |-.19                     |-.22                |-.33                 |-.58                 |-.04                 |.03                       |-.05          |.00                     |.01                      |-.07              |-.03               |.08                 |.05                      |-.07                   |-.10                    |.21                       |.01                 |.09               |-.11               |-.05                |.03                 |-.04             |-.00                  |.00                 |.07                      |.18                       |.18                  |.20                        |.18                             |.21                       |.19                            |-.11                          |.06                       |-.01                           |-.03                     |-.03                       |-.03                            |-.02                      |-.04                           |-.01               |.17            |.15                 |.09               |-.06               |-.05                      |-.03                           |.06                      |-.11                |.08          |.01           |-.01             |.04         |.06                |.13           |.06                 |.08                |.02                      |.02                |.08                   |.09                |.16                    |.25                      |.19                     |NA             |
|Authenticity_confleft_Forgery   |-.06                     |-.09                    |-.15                |-.18                      |-.17                     |-.11                |-.16                 |-.19                 |-.02                 |.03                       |-.03          |.08                     |.15                      |-.15              |-.05               |.01                 |.03                      |.04                    |.03                     |.15                       |.03                 |.12               |-.06               |-.01                |-.04                |-.06             |-.06                  |-.09                |-.03                     |.29                       |.27                  |.34                        |.38                             |.41                       |.46                            |-.01                          |.00                       |-.06                           |-.00                     |.03                        |.01                             |.06                       |-.10                           |.05                |-.02           |-.02                |-.07              |-.08               |-.08                      |-.02                           |.11                      |.01                 |.03          |-.02          |-.09             |-.01        |-.09               |-.05          |-.06                |-.09               |-.13                     |.00                |.08                   |.12                |.11                    |.14                      |.11                     |.18            |
...
# Network loadings and scores (one row per participant, in the order of df_wide).
# The higher-order scores are computed from the lower-order scores as estimated,
# since the higher-order network was estimated on them
...
```{.r .cell-code}
# Orientation (2026-09-26): the scores follow the sign of the loadings, which
# made a high "Anti-fake bias" score a smaller penalty and a high "Ugliness
# extremity" score milder ugliness judgments. These two communities are reversed
# so that a high score means more of what the label says; each higher-order
# score is then oriented so that its dominant lower-order community loads
# positively. Scores and loadings (the edge signs) are reversed together.
flip_lower <- as.character(tree_lower$Lower[tree_lower$Label %in% c("Anti-fake bias", "Ugliness extremity")])
stopifnot(length(flip_lower) == 2)
loads_lower[, flip_lower] <- -loads_lower[, flip_lower]
loads_higher[flip_lower, ] <- -loads_higher[flip_lower, ]
scores_lower[, flip_lower] <- -scores_lower[, flip_lower]
dominant <- sapply(colnames(loads_higher), \(h) {
  l <- loads_higher[names(ega$higher_order$wc)[ega$higher_order$wc == as.numeric(h)], h]
  l[which.max(abs(l))]
})
flip_higher <- colnames(loads_higher)[dominant < 0]
loads_higher[, flip_higher] <- -loads_higher[, flip_higher]
scores_higher[, flip_higher] <- -scores_higher[, flip_higher]
...
Orientation (2026-09-26): the network scores follow the sign of the loadings,
which made a high *Anti-fake bias* score a *smaller* penalty and a high
*Ugliness extremity* score *milder* ugliness judgments (Beauty `confleft`
loads negatively). Both are reversed, scores and loadings together, so that a
high score means more of what the label says: the label contrasts now load
negatively on *Anti-fake bias* (a larger bias is a more negative AI / Forgery
− Original contrast), and `precleft` negatively on *Ugliness extremity*. Each
higher-order score is then oriented so that its dominant lower-order community
loads positively, which reverses *Aesthetic appraisal* (dominated by
*Ugliness extremity*).
...
Participant-level indices from the follow-up memory models (220
...
- **SDT** (2026-09-26, label model only): the signal-detection reading of the
  two recognition indices, per draw: *Sensitivity* = logit(hits) - logit(false
  alarms), the log-odds analogue of *d'*; *Bias* = their mean, higher = more
  "seen before" answers whatever the item (a liberal criterion).
- **Seen before** (2026-09-26, `MemorySR`, `6_selfrelevance.qmd` section C):
  the slope of the log odds of answering "seen before" on the participant's
  own self-relevance and follow-up beauty of the artwork (per full range of
  the rating, the other rating at their mean): the familiarity bias for
  resonant or liked works. The model's random part has no Type term for the
  ratings, so one slope per participant covers hits and false alarms. Both
  slopes are borderline reliable (D-vour .35 / .36) and correlate .76 with
  each other (the two ratings are collinear within participant), and neither
  correlates with any dimension score, slope or trait (all |r| ≤ .19): kept
  in the tables for completeness, not interpreted.
...
memory_models <- c("MemoryCondition", "MemoryBelief", "MemorySR")
df_mem <- read_estimates(memory_models, dir = "individual") |>
  ...
  mutate(Model = factor(Model, levels = memory_models),
         Parameter = factor(Parameter, levels = c("Recognition", "SDT", "Accuracy", "Tendency", "Seen before")),
         Index = fct_inorder(recode(Index, SR_w = "Self-relevance", Beauty2_w = "Follow-up beauty"))) |>
...
<td headers="CI_high" class="gt_row gt_right gt_striped">0.87</td></tr>
    <tr><td headers="Model" class="gt_row gt_center">MemoryCondition</td>
<td headers="Parameter" class="gt_row gt_center">SDT</td>
<td headers="Index" class="gt_row gt_center">Sensitivity</td>
<td headers="Probability" class="gt_row gt_right">0.89</td>
<td headers="D_vour" class="gt_row gt_right">0.70</td>
<td headers="CI_low" class="gt_row gt_right">0.64</td>
<td headers="CI_high" class="gt_row gt_right">0.74</td></tr>
    <tr><td headers="Model" class="gt_row gt_center gt_striped">MemoryCondition</td>
<td headers="Parameter" class="gt_row gt_center gt_striped">SDT</td>
<td headers="Index" class="gt_row gt_center gt_striped">Bias</td>
<td headers="Probability" class="gt_row gt_right gt_striped">0.20</td>
<td headers="D_vour" class="gt_row gt_right gt_striped">0.91</td>
<td headers="CI_low" class="gt_row gt_right gt_striped">0.89</td>
<td headers="CI_high" class="gt_row gt_right gt_striped">0.92</td></tr>
    <tr><td headers="Model" class="gt_row gt_center">MemoryCondition</td>
...
<td headers="CI_high" class="gt_row gt_right">0.68</td></tr>
    <tr><td headers="Model" class="gt_row gt_center gt_striped">MemorySR</td>
<td headers="Parameter" class="gt_row gt_center gt_striped">Seen before</td>
<td headers="Index" class="gt_row gt_center gt_striped">Self-relevance</td>
<td headers="Probability" class="gt_row gt_right gt_striped">0.76</td>
<td headers="D_vour" class="gt_row gt_right gt_striped">0.35</td>
<td headers="CI_low" class="gt_row gt_right gt_striped">0.30</td>
<td headers="CI_high" class="gt_row gt_right gt_striped">0.39</td></tr>
    <tr><td headers="Model" class="gt_row gt_center">MemorySR</td>
<td headers="Parameter" class="gt_row gt_center">Seen before</td>
<td headers="Index" class="gt_row gt_center">Follow-up beauty</td>
<td headers="Probability" class="gt_row gt_right">0.63</td>
<td headers="D_vour" class="gt_row gt_right">0.36</td>
<td headers="CI_low" class="gt_row gt_right">0.31</td>
<td headers="CI_high" class="gt_row gt_right">0.41</td></tr>
  </tbody>
...
|MemoryCondition |SDT         |Sensitivity      |0.89        |0.70   |0.64   |0.74    |
|MemoryCondition |SDT         |Bias             |0.20        |0.91   |0.89   |0.92    |
...
|MemorySR        |Seen before |Self-relevance   |0.76        |0.35   |0.30   |0.39    |
|MemorySR        |Seen before |Follow-up beauty |0.63        |0.36   |0.31   |0.41    |
...
df_mem_rel |>
  ...
  facet_grid(Model ~ ., scales = "free_y", space = "free_y") +
  scale_color_manual(values = c("Recognition" = "#607D8B", "SDT" = "#455A64", "Accuracy" = "#4CAF50", "Tendency" = "#9C27B0", "Seen before" = "#26A69A")) +
  scale_x_continuous(limits = c(0, 1), expand = c(0, 0.01)) +
  labs(x = "D-vour", y = NULL, color = NULL) +
  theme_minimal() +
  theme(legend.position = "top", strip.text.y = element_text(angle = 0, face = "bold"))
...
The memory indices with D-vour > 1/3 are used as correlates, on the logit
scale: *Recognition* (hits and false alarms) and its signal-detection reading
(*Sensitivity*, *Bias*), the tendency to recall a recognised item's label
(*Recalled label*) or one's own Phase-2 belief (*Recalled belief*) as each
category, and the *familiarity bias* slopes. Within a model the tendencies sum
to 1, so they are not independent of each other. The accuracy indices are
dominated by uncertainty and left out.

Reading (2026-09-26): the signal-detection indices are reliable (Sensitivity
.70, Bias .91) and the two follow-up traits relate to them in one way only:
participants who find the artworks more self-relevant on average make more
false alarms (*r* = .36), are less sensitive (-.26) and more liberal (.31),
with no relation to hits; mean follow-up beauty shows the same pattern more
weakly. Neither trait, nor any memory index, relates to the anti-fake bias or
to interoception.
...
mem_vars <- df_mem_rel |>
  ...
  transmute(Score = as.character(Feature), Column = as.character(Index),
            ColGroup = case_when(Parameter == "Recognition" ~ "Recognition",
                                 Parameter == "SDT" ~ "Signal detection",
                                 Model == "MemorySR" ~ "Familiarity bias",
...
|Row                                        |Recognition: Hits |Recognition: False alarms |Signal detection: Sensitivity |Signal detection: Bias |Recalled label: Human Original |Recalled label: Human Forgery |Recalled label: AI-Generated |Recalled belief: Human Original |Recalled belief: Human Forgery |Recalled belief: AI Original |Recalled belief: AI Copy |Familiarity bias: Self-relevance |Familiarity bias: Follow-up beauty |
|:------------------------------------------|:-----------------|:-------------------------|:-----------------------------|:----------------------|:------------------------------|:-----------------------------|:----------------------------|:-------------------------------|:------------------------------|:----------------------------|:------------------------|:--------------------------------|:----------------------------------|
|Demographics: Age                          |.04               |.03                       |.00                           |.04                    |.20                            |-.17                          |-.09                         |.15                             |-.15                           |.11                          |-.16                     |.07                              |-.02                               |
|Demographics: Education                    |.08               |.11                       |-.06                          |.10                    |.01                            |-.06                          |.04                          |-.06                            |-.06                           |.09                          |.02                      |-.06                             |-.06                               |
|Demographics: Gender (male)                |-.00              |.04                       |-.06                          |.02                    |-.09                           |.04                           |.06                          |.05                             |-.08                           |-.04                         |-.01                     |.10                              |.15                                |
|Demographics: Art expertise                |.06               |.15                       |-.14                          |.12                    |-.05                           |-.02                          |.07                          |.02                             |-.06                           |-.07                         |.05                      |.02                              |.11                                |
|AI attitudes: Manipulation distrust        |.15               |-.01                      |.19                           |.07                    |-.04                           |-.05                          |.08                          |.03                             |.03                            |.05                          |-.10                     |-.10                             |-.13                               |
|AI attitudes: AI attitudes (negative)      |-.03              |-.02                      |-.01                          |-.03                   |.02                            |.02                           |-.06                         |-.10                            |.07                            |-.02                         |.05                      |-.00                             |-.04                               |
|AI attitudes: AI art realism               |-.06              |-.03                      |-.03                          |-.05                   |-.03                           |-.10                          |.08                          |.05                             |-.10                           |.04                          |.02                      |.05                              |.05                                |
|AI attitudes: AI attitudes (positive)      |-.03              |.01                       |-.04                          |-.01                   |-.04                           |-.09                          |.11                          |.12                             |-.13                           |-.01                         |-.01                     |.07                              |.12                                |
|AI attitudes: AI knowledge                 |.02               |.10                       |-.12                          |.07                    |-.19                           |.11                           |.14                          |.00                             |-.07                           |-.03                         |.05                      |-.01                             |.09                                |
|AI attitudes: AI use                       |.08               |.12                       |-.07                          |.11                    |-.22                           |.12                           |.15                          |-.03                            |.02                            |.00                          |.01                      |.01                              |.06                                |
|Imagery & mood: Depression                 |-.05              |-.06                      |.03                           |-.06                   |-.01                           |.07                           |-.04                         |-.05                            |-.01                           |.06                          |.02                      |-.04                             |-.01                               |
|Imagery & mood: Anxiety                    |.01               |-.04                      |.07                           |-.01                   |-.00                           |.02                           |-.01                         |-.15                            |.06                            |.07                          |.05                      |-.08                             |-.07                               |
|Imagery & mood: Life satisfaction          |-.03              |.00                       |-.04                          |-.01                   |-.02                           |-.06                          |.06                          |.01                             |-.02                           |-.08                         |.08                      |.04                              |.02                                |
|Imagery & mood: Visual imagery (VVIQ)      |.06               |.10                       |-.07                          |.09                    |-.02                           |.03                           |-.01                         |-.03                            |.01                            |-.08                         |.05                      |.00                              |.06                                |
|Follow-up ratings: Follow-up beauty (mean) |.17               |.22                       |-.11                          |.21                    |-.02                           |.09                           |-.02                         |-.00                            |.15                            |-.12                         |-.06                     |.07                              |.12                                |
|Follow-up ratings: Self-relevance (mean)   |.20               |.36*                      |-.26*                         |.31*                   |-.08                           |.02                           |.09                          |-.01                            |.17                            |-.16                         |-.02                     |.05                              |.11                                |
|Interoception: Awareness                   |.03               |-.01                      |.05                           |.01                    |.04                            |-.02                          |-.04                         |.03                             |-.02                           |-.01                         |.00                      |-.11                             |-.07                               |
|Interoception: *MINT ExAc*                 |.04               |-.05                      |.12                           |-.01                   |.11                            |-.09                          |-.08                         |.05                             |-.07                           |.04                          |-.00                     |-.14                             |-.15                               |
|Interoception: *MINT RelA*                 |.03               |-.00                      |.04                           |.01                    |-.04                           |.09                           |-.03                         |-.02                            |-.01                           |-.02                         |.00                      |-.05                             |-.03                               |
|Interoception: *MINT SexS*                 |-.00              |.03                       |-.04                          |.01                    |.03                            |-.05                          |.01                          |.05                             |.01                            |-.03                         |.00                      |-.05                             |.00                                |
|Interoception: Deficit                     |.03               |.10                       |-.10                          |.07                    |-.06                           |.02                           |.05                          |-.10                            |.04                            |.08                          |.01                      |-.05                             |-.05                               |
|Interoception: *MINT CaCo*                 |-.06              |.03                       |-.12                          |-.01                   |-.06                           |-.00                          |.09                          |-.08                            |.01                            |.10                          |.03                      |.00                              |-.07                               |
|Interoception: *MINT Urin*                 |-.03              |.11                       |-.19                          |.05                    |-.06                           |.04                           |.03                          |-.06                            |.04                            |.06                          |-.08                     |-.01                             |-.03                               |
|Interoception: *MINT Derm*                 |.14               |.03                       |.13                           |.09                    |.02                            |.00                           |-.04                         |-.04                            |-.02                           |.04                          |.06                      |-.13                             |-.17                               |
|Interoception: *MINT Sati*                 |-.01              |.06                       |-.09                          |.03                    |.01                            |-.06                          |.03                          |-.07                            |.03                            |.05                          |-.02                     |.03                              |.10                                |
|Interoception: *MINT Olfa*                 |.04               |.07                       |-.06                          |.06                    |-.11                           |.08                           |.06                          |-.06                            |.08                            |.01                          |.03                      |-.05                             |.02                                |
|Interoception: Visceroception              |-.04              |.05                       |-.12                          |.01                    |-.08                           |.06                           |.06                          |-.11                            |.02                            |.06                          |.07                      |-.02                             |-.06                               |
|Interoception: *MINT Resp*                 |-.06              |.05                       |-.13                          |.00                    |-.12                           |.05                           |.10                          |-.10                            |.00                            |.07                          |.08                      |.03                              |-.05                               |
|Interoception: *MINT Card*                 |-.05              |.02                       |-.09                          |-.01                   |-.04                           |.00                           |.08                          |-.06                            |-.01                           |.07                          |.06                      |-.02                             |-.05                               |
|Interoception: *MINT Gast*                 |-.01              |.07                       |-.11                          |.04                    |-.07                           |.12                           |-.01                         |-.13                            |.05                            |.04                          |.07                      |-.07                             |-.06                               |
...
The scores are oriented so that a high score means more of what the label
says (see the EGA section): a high *Anti-fake bias* score is a larger penalty
for the non-original labels, a high *Ugliness extremity* score more extreme
ugliness judgments. *Belief consistency* (the precision of the Phase-2
...
```{.r .cell-code}
# The slope indices (posterior means, link scale) that reach D-vour > 1/3
slope_labels <- c(RealityBeauty_mu_Slope = "Beauty slope",
                  BeautySR_mu_Slope = "Self-relevance -> beauty",
                  MeaningSR_mu_Slope = "Self-relevance -> meaning",
                  MeaningSR_pzero_Slope = "Self-relevance -> P(meaning = 0)",
                  Beauty2Reality_mu_Slope = "Belief -> follow-up beauty")
slope_groups <- c(RealityBeauty_mu_Slope = "Beauty = human",
                  BeautySR_mu_Slope = "Self-relevance coupling",
                  MeaningSR_mu_Slope = "Self-relevance coupling",
                  MeaningSR_pzero_Slope = "Self-relevance coupling",
                  Beauty2Reality_mu_Slope = "Belief carry-over")
slope_vars <- df_rel |>
  filter(Model %in% slope_models, D_vour > 1/3) |>
  transmute(Score = as.character(Feature),
            Column = coalesce(slope_labels[Score], Score),
            ColGroup = coalesce(slope_groups[Score], "Slopes"))
...
dim_vars <- bind_rows(
  ...
  # The slope indices, not part of the EGA (posterior means, link scale),
  # where reliable (D-vour > 1/3)
  bind_rows(slope_vars)
...
fill_higher <- c(setNames(pal_higher[paste0("H", tree_higher$Higher)], tree_higher$Label),
                 ...
                 "Self-relevance coupling" = "#26A69A", "Belief carry-over" = "#5C6BC0")
...
df_correlates <- cor_grid(df_scores_all, row_vars, dim_vars)
...
|Row                                        |Aesthetic appraisal: Overall |Aesthetic appraisal: Aesthetic sensitivity |Aesthetic appraisal: Anti-fake bias |Aesthetic appraisal: Rating consistency |Aesthetic appraisal: Ugliness extremity |Realness beliefs: Overall |Realness beliefs: Realness tendency |Realness beliefs: Realness conviction |Realness beliefs: Fakeness conviction |Beauty = human: Beauty slope |Self-relevance coupling: Self-relevance -> beauty |Self-relevance coupling: Self-relevance -> meaning |
|:------------------------------------------|:----------------------------|:------------------------------------------|:-----------------------------------|:---------------------------------------|:---------------------------------------|:-------------------------|:-----------------------------------|:-------------------------------------|:-------------------------------------|:----------------------------|:-------------------------------------------------|:--------------------------------------------------|
|Demographics: Education                    |-.07                         |.09                                        |.03                                 |.02                                     |-.06                                    |-.12                      |.05                                 |-.10                                  |-.12                                  |.02                          |-.09                                              |-.02                                               |
|Demographics: Gender (male)                |-.15                         |.09                                        |-.02                                |.08                                     |-.15                                    |.07                       |.07                                 |.05                                   |.07                                   |-.03                         |-.14                                              |.03                                                |
|Demographics: Art expertise                |-.11                         |.35*                                       |.11                                 |-.18*                                   |-.08                                    |-.02                      |-.01                                |.00                                   |-.04                                  |-.01                         |-.06                                              |.11                                                |
|Demographics: Age                          |.15                          |-.10                                       |-.13                                |.03                                     |.15                                     |.05                       |-.01                                |.05                                   |.05                                   |.02                          |.07                                               |.06                                                |
|AI attitudes: Manipulation distrust        |-.11                         |.14                                        |-.02                                |-.02                                    |-.10                                    |-.01                      |.15                                 |.04                                   |-.07                                  |-.01                         |-.01                                              |-.10                                               |
|AI attitudes: AI attitudes (negative)      |-.12                         |.04                                        |.36*                                |.07                                     |-.09                                    |-.09                      |.00                                 |-.10                                  |-.07                                  |.07                          |.01                                               |-.02                                               |
|AI attitudes: AI art realism               |.09                          |-.05                                       |-.37*                               |-.05                                    |.06                                     |.13                       |-.01                                |.13                                   |.12                                   |-.08                         |-.20*                                             |-.02                                               |
|AI attitudes: AI knowledge                 |-.00                         |.29*                                       |-.04                                |-.23*                                   |.01                                     |.11                       |.16                                 |.15                                   |.07                                   |-.01                         |-.19                                              |-.04                                               |
|AI attitudes: AI attitudes (positive)      |.03                          |.17*                                       |-.25*                               |-.10                                    |.03                                     |.23*                      |.06                                 |.23*                                  |.22*                                  |-.09                         |-.23*                                             |-.04                                               |
|AI attitudes: AI use                       |.07                          |.16                                        |-.08                                |-.17*                                   |.07                                     |.24*                      |.06                                 |.24*                                  |.21*                                  |-.08                         |-.30*                                             |-.14                                               |
|Imagery & mood: Depression                 |.07                          |-.02                                       |.07                                 |-.04                                    |.07                                     |-.04                      |.01                                 |-.03                                  |-.05                                  |.03                          |-.05                                              |.01                                                |
|Imagery & mood: Anxiety                    |.08                          |-.01                                       |.03                                 |-.12                                    |.08                                     |.01                       |.02                                 |.03                                   |-.02                                  |.05                          |-.09                                              |.00                                                |
|Imagery & mood: Life satisfaction          |-.02                         |.12                                        |-.13                                |-.02                                    |-.01                                    |.04                       |.06                                 |.03                                   |.05                                   |-.01                         |.05                                               |.03                                                |
|Imagery & mood: Visual imagery (VVIQ)      |-.05                         |.20*                                       |.12                                 |-.11                                    |-.03                                    |.10                       |.05                                 |.11                                   |.09                                   |-.03                         |-.00                                              |-.04                                               |
|Follow-up ratings: Follow-up beauty (mean) |-.41*                        |.64*                                       |.11                                 |-.12                                    |-.37*                                   |.06                       |.14                                 |.09                                   |.02                                   |-.07                         |-.31*                                             |-.15                                               |
|Follow-up ratings: Self-relevance (mean)   |-.26*                        |.37*                                       |-.01                                |-.10                                    |-.25*                                   |.01                       |.16                                 |.07                                   |-.06                                  |-.07                         |-.30*                                             |-.01                                               |
|Interoception: Awareness                   |.06                          |.17*                                       |-.02                                |-.15                                    |.08                                     |.24*                      |.14                                 |.26*                                  |.21*                                  |-.06                         |.06                                               |.00                                                |
|Interoception: *MINT ExAc*                 |.04                          |.04                                        |-.01                                |-.06                                    |.04                                     |.20*                      |.10                                 |.20*                                  |.17*                                  |-.01                         |.08                                               |-.00                                               |
|Interoception: *MINT RelA*                 |-.04                         |.21*                                       |-.02                                |-.07                                    |-.02                                    |.19*                      |.09                                 |.21*                                  |.14                                   |-.13                         |-.01                                              |-.02                                               |
|Interoception: *MINT SexS*                 |.14                          |.14                                        |-.02                                |-.20*                                   |.15                                     |.17*                      |.12                                 |.17*                                  |.15                                   |.01                          |.07                                               |.02                                                |
|Interoception: Deficit                     |-.02                         |.09                                        |.07                                 |-.10                                    |-.01                                    |.11                       |.03                                 |.12                                   |.10                                   |-.01                         |-.00                                              |.01                                                |
|Interoception: *MINT CaCo*                 |-.02                         |.05                                        |.09                                 |-.04                                    |-.01                                    |.01                       |-.07                                |.00                                   |.01                                   |.03                          |-.04                                              |.07                                                |
|Interoception: *MINT Urin*                 |-.01                         |.05                                        |-.01                                |-.03                                    |-.01                                    |.02                       |.03                                 |.02                                   |.02                                   |.02                          |-.08                                              |-.03                                               |
|Interoception: *MINT Derm*                 |.05                          |.06                                        |.10                                 |-.15                                    |.05                                     |.08                       |.07                                 |.10                                   |.06                                   |-.03                         |.07                                               |-.04                                               |
|Interoception: *MINT Sati*                 |-.00                         |.05                                        |.03                                 |-.05                                    |.00                                     |.13                       |.03                                 |.14                                   |.11                                   |.02                          |.02                                               |.06                                                |
|Interoception: *MINT Olfa*                 |-.08                         |.06                                        |.02                                 |-.04                                    |-.08                                    |.12                       |.03                                 |.11                                   |.13                                   |-.06                         |.02                                               |-.02                                               |
|Interoception: Visceroception              |-.01                         |.19*                                       |.05                                 |-.11                                    |.00                                     |.20*                      |.06                                 |.21*                                  |.17*                                  |-.07                         |.06                                               |.09                                                |
|Interoception: *MINT Resp*                 |-.03                         |.18*                                       |.01                                 |-.07                                    |-.01                                    |.19*                      |-.02                                |.19*                                  |.18*                                  |-.07                         |.07                                               |.11                                                |
|Interoception: *MINT Card*                 |-.03                         |.18*                                       |.05                                 |-.07                                    |-.01                                    |.11                       |.10                                 |.13                                   |.08                                   |-.08                         |.08                                               |.11                                                |
|Interoception: *MINT Gast*                 |.02                          |.14                                        |.07                                 |-.15                                    |.03                                     |.23*                      |.07                                 |.24*                                  |.20*                                  |-.04                         |.01                                               |.04                                                |
|Recognition: False alarms                  |-.15                         |.08                                        |.07                                 |-.04                                    |-.16                                    |.07                       |-.01                                |.09                                   |.04                                   |-.11                         |-.06                                              |-.13                                               |
|Recognition: Hits                          |-.13                         |.01                                        |.08                                 |.05                                     |-.13                                    |.05                       |.06                                 |.09                                   |.01                                   |-.11                         |.02                                               |-.19                                               |
|Signal detection: Bias                     |-.15                         |.05                                        |.08                                 |.00                                     |-.16                                    |.07                       |.03                                 |.10                                   |.03                                   |-.12                         |-.02                                              |-.17                                               |
|Signal detection: Sensitivity              |.06                          |-.10                                       |-.01                                |.12                                     |.07                                     |-.03                      |.09                                 |-.02                                  |-.04                                  |.03                          |.10                                               |-.04                                               |
|Recalled label: AI-Generated               |-.02                         |.04                                        |-.11                                |-.04                                    |-.03                                    |-.05                      |-.06                                |-.07                                  |-.03                                  |-.07                         |-.07                                              |-.03                                               |
|Recalled label: Human Forgery              |-.10                         |.05                                        |.08                                 |.03                                     |-.10                                    |.02                       |-.02                                |.02                                   |.02                                   |-.03                         |-.04                                              |-.01                                               |
|Recalled label: Human Original             |.10                          |-.05                                       |.02                                 |-.00                                    |.10                                     |.05                       |.06                                 |.07                                   |.03                                   |.06                          |.06                                               |.04                                                |
|Recalled belief: AI Copy                   |-.06                         |-.04                                       |.01                                 |.01                                     |-.07                                    |-.07                      |-.14                                |-.09                                  |-.05                                  |-.01                         |.04                                               |-.00                                               |
|Recalled belief: AI Original               |.03                          |-.16                                       |-.02                                |.13                                     |.03                                     |-.18                      |-.13                                |-.20*                                 |-.14                                  |.04                          |.13                                               |.02                                                |
|Recalled belief: Human Forgery             |.02                          |.10                                        |.07                                 |-.16                                    |.02                                     |.14                       |.02                                 |.16                                   |.12                                   |.00                          |-.15                                              |-.05                                               |
|Recalled belief: Human Original            |-.00                         |.08                                        |-.00                                |.04                                     |.02                                     |.03                       |.18                                 |.06                                   |.00                                   |-.07                         |.04                                               |.01                                                |
|Familiarity bias: Follow-up beauty         |-.05                         |.10                                        |.03                                 |-.02                                    |-.05                                    |.04                       |-.06                                |.02                                   |.05                                   |.01                          |-.08                                              |.03                                                |
|Familiarity bias: Self-relevance           |-.05                         |.08                                        |.05                                 |.05                                     |-.03                                    |-.00                      |-.08                                |-.01                                  |.02                                   |-.02                         |-.02                                              |.08                                                |
...
### Manuscript figure: interindividual differences

The manuscript figure's lower panel (2026-09-26) is organised differently from
the table above: rows are the dispositional characteristics only, columns
everything participants did in the study, i.e. the Phase-1 and Phase-2
community scores and the follow-up label recall tendencies (the tendency to
recall a recognised work's label as each category, whatever its actual label).
Left out, for focus: the *Beauty = human* slope (no correlate), the
self-relevance coupling slopes (borderline reliable; their AI-attitude
correlates are in the table above), the mean follow-up ratings (related to
aesthetic sensitivity, not to the label effects) and the general memory
indices (recognition, signal detection, familiarity bias) and the recalled
beliefs (their only trait correlates, with age, are |*r*| ≤ .16 and none
survives the FDR correction), and the higher-order (*Overall*) scores, each
nearly identical to one or two of its lower-order communities (*Aesthetic
appraisal* to *Ugliness extremity*, *r* = .99; *Realness beliefs* to the two
conviction scores, .97). The correlations of the recalled labels with the
community scores (in the table above) are null (all |*r*| ≤ .11). The FDR
correction is recomputed over the correlations shown.


::: {.cell}

```{.r .cell-code}
ms_rows <- filter(trait_vars, RowGroup != "Follow-up ratings")
ms_cols <- bind_rows(filter(dim_vars, ColGroup %in% tree_higher$Label, Column != "Overall"),
                     filter(mem_vars, ColGroup == "Recalled label"))
df_correlates_ms <- cor_grid(df_scores_all, ms_rows, ms_cols)
cor_markdown(df_correlates_ms, "Manuscript figure: correlations between participant characteristics and community scores and label recall tendencies (*: FDR-corrected p < .05)")
```

::: {.cell-output-display}
::: {.callout-note collapse="true" title="Manuscript figure: correlations between participant characteristics and community scores and label recall tendencies (*: FDR-corrected p < .05) (Markdown table, for text readers)"}

|Row                                   |Aesthetic appraisal: Aesthetic sensitivity |Aesthetic appraisal: Anti-fake bias |Aesthetic appraisal: Rating consistency |Aesthetic appraisal: Ugliness extremity |Realness beliefs: Realness tendency |Realness beliefs: Realness conviction |Realness beliefs: Fakeness conviction |Recalled label: Human Original |Recalled label: Human Forgery |Recalled label: AI-Generated |
|:-------------------------------------|:------------------------------------------|:-----------------------------------|:---------------------------------------|:---------------------------------------|:-----------------------------------|:-------------------------------------|:-------------------------------------|:------------------------------|:-----------------------------|:----------------------------|
|Demographics: Age                     |-.10                                       |-.13                                |.03                                     |.15                                     |-.01                                |.05                                   |.05                                   |.20*                           |-.17                          |-.09                         |
|Demographics: Education               |.09                                        |.03                                 |.02                                     |-.06                                    |.05                                 |-.10                                  |-.12                                  |.01                            |-.06                          |.04                          |
|Demographics: Gender (male)           |.09                                        |-.02                                |.08                                     |-.15                                    |.07                                 |.05                                   |.07                                   |-.09                           |.04                           |.06                          |
|Demographics: Art expertise           |.35*                                       |.11                                 |-.18*                                   |-.08                                    |-.01                                |.00                                   |-.04                                  |-.05                           |-.02                          |.07                          |
|AI attitudes: AI attitudes (negative) |.04                                        |.36*                                |.07                                     |-.09                                    |.00                                 |-.10                                  |-.07                                  |.02                            |.02                           |-.06                         |
|AI attitudes: AI art realism          |-.05                                       |-.37*                               |-.05                                    |.06                                     |-.01                                |.13                                   |.12                                   |-.03                           |-.10                          |.08                          |
|AI attitudes: AI attitudes (positive) |.17*                                       |-.25*                               |-.10                                    |.03                                     |.06                                 |.23*                                  |.22*                                  |-.04                           |-.09                          |.11                          |
|AI attitudes: Manipulation distrust   |.14                                        |-.02                                |-.02                                    |-.10                                    |.15                                 |.04                                   |-.07                                  |-.04                           |-.05                          |.08                          |
|AI attitudes: AI knowledge            |.29*                                       |-.04                                |-.23*                                   |.01                                     |.16                                 |.15                                   |.07                                   |-.19                           |.11                           |.14                          |
|AI attitudes: AI use                  |.16*                                       |-.08                                |-.17*                                   |.07                                     |.06                                 |.24*                                  |.21*                                  |-.22*                          |.12                           |.15                          |
|Imagery & mood: Anxiety               |-.01                                       |.03                                 |-.12                                    |.08                                     |.02                                 |.03                                   |-.02                                  |-.00                           |.02                           |-.01                         |
|Imagery & mood: Depression            |-.02                                       |.07                                 |-.04                                    |.07                                     |.01                                 |-.03                                  |-.05                                  |-.01                           |.07                           |-.04                         |
|Imagery & mood: Life satisfaction     |.12                                        |-.13                                |-.02                                    |-.01                                    |.06                                 |.03                                   |.05                                   |-.02                           |-.06                          |.06                          |
|Imagery & mood: Visual imagery (VVIQ) |.20*                                       |.12                                 |-.11                                    |-.03                                    |.05                                 |.11                                   |.09                                   |-.02                           |.03                           |-.01                         |
|Interoception: Awareness              |.17*                                       |-.02                                |-.15                                    |.08                                     |.14                                 |.26*                                  |.21*                                  |.04                            |-.02                          |-.04                         |
|Interoception: *MINT ExAc*            |.04                                        |-.01                                |-.06                                    |.04                                     |.10                                 |.20*                                  |.17*                                  |.11                            |-.09                          |-.08                         |
|Interoception: *MINT RelA*            |.21*                                       |-.02                                |-.07                                    |-.02                                    |.09                                 |.21*                                  |.14                                   |-.04                           |.09                           |-.03                         |
|Interoception: *MINT SexS*            |.14                                        |-.02                                |-.20*                                   |.15                                     |.12                                 |.17*                                  |.15                                   |.03                            |-.05                          |.01                          |
|Interoception: Deficit                |.09                                        |.07                                 |-.10                                    |-.01                                    |.03                                 |.12                                   |.10                                   |-.06                           |.02                           |.05                          |
|Interoception: *MINT CaCo*            |.05                                        |.09                                 |-.04                                    |-.01                                    |-.07                                |.00                                   |.01                                   |-.06                           |-.00                          |.09                          |
|Interoception: *MINT Urin*            |.05                                        |-.01                                |-.03                                    |-.01                                    |.03                                 |.02                                   |.02                                   |-.06                           |.04                           |.03                          |
|Interoception: *MINT Derm*            |.06                                        |.10                                 |-.15                                    |.05                                     |.07                                 |.10                                   |.06                                   |.02                            |.00                           |-.04                         |
|Interoception: *MINT Sati*            |.05                                        |.03                                 |-.05                                    |.00                                     |.03                                 |.14                                   |.11                                   |.01                            |-.06                          |.03                          |
|Interoception: *MINT Olfa*            |.06                                        |.02                                 |-.04                                    |-.08                                    |.03                                 |.11                                   |.13                                   |-.11                           |.08                           |.06                          |
|Interoception: Visceroception         |.19*                                       |.05                                 |-.11                                    |.00                                     |.06                                 |.21*                                  |.17*                                  |-.08                           |.06                           |.06                          |
|Interoception: *MINT Resp*            |.18*                                       |.01                                 |-.07                                    |-.01                                    |-.02                                |.19*                                  |.18*                                  |-.12                           |.05                           |.10                          |
|Interoception: *MINT Card*            |.18*                                       |.05                                 |-.07                                    |-.01                                    |.10                                 |.13                                   |.08                                   |-.04                           |.00                           |.08                          |
|Interoception: *MINT Gast*            |.14                                        |.07                                 |-.15                                    |.03                                     |.07                                 |.24*                                  |.20*                                  |-.07                           |.12                           |-.01                         |

:::
:::

```{.r .cell-code}
fill_ms <- c(fill_higher, "Recalled label" = "#BF360C")
```
:::
...
```{.r .cell-code}
# Manuscript figure of the "Interindividual Differences" section (figures/figure_interindividual.png).
...
figure_interindividual <- free(p_ega_matrix) /
  (cor_heatmap(df_correlates_ms, base_size = 20, text_size = 5.2, col_fill = fill_ms) +
     theme(legend.position = "none", plot.margin = margin(t = 0.1, unit = "in"))) +
  plot_layout(heights = c(19.4, 10.6))

figure_interindividual

ggsave("figures/figure_interindividual.png", figure_interindividual, width = 20, height = 30, dpi = 300, bg = "white")
```

::: {.cell-output-display}
![Structure and correlates of the participant-level indices. Top: correlations between the indices entering the EGA (lower half), their reliability (diagonal) and their hierarchical community structure (upper half). Bottom: correlations between participant characteristics (rows) and the lower-order community scores and the follow-up label recall tendencies (columns: the tendency to recall a recognised work as having had each label, whatever its actual label).](7_correlates_files/figure-html/fig-interindividual-1.png){#fig-interindividual fig-alt='Top: triangular correlation matrix of the participant-level indices with a tree of their lower- and higher-order communities drawn above the diagonal. Bottom: heatmap of correlations between participant characteristics and the community scores and label recall tendencies.' width=1920}
:::
:::
