...
#
# The PCH is per account (~/.cmdstan), not per project: if the IGComputational
# fits have already built the threaded/nochecks variant on this account, this
# finishes in seconds and reports it present.
