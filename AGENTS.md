...
| 5 | `analysis/5_correlates.qmd` | `models/individual/*.rds` (`./hpc individual`, `get_individual()` in `server/estimates.R`) | HTML report + `5_correlates.html.md`; participant-level indices (link-scale Baseline, Forgery − Original, AI − Original per dpar) |
